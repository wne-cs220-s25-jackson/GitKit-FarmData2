...
export declare class DocumentsMainImpl implements DocumentsMain, Disposable {
    ...
    constructor(editorsAndDocuments: EditorsAndDocumentsMain, notebookDocuments: NotebookDocumentsMainImpl, modelService: EditorModelService, rpc: RPCProtocol, openerService: OpenerService, shell: ApplicationShell, untitledResourceResolver: UntitledResourceResolver, languageService: MonacoLanguages);
    dispose(): void;
