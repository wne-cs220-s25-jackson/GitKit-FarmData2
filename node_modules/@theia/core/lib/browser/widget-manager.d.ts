...
export declare class WidgetManager {
    ...
    protected readonly pendingWidgetPromises: Map<string, Promise<Widget>>;
     ...
     * @returns a promise resolving to the widget if available, else `undefined`.
     */
    findWidget<T extends Widget>(factoryId: string, predicate: (options?: any) => boolean): Promise<T | undefined>;
    ...
    protected doCreateWidget<T extends Widget>(factory: WidgetFactory, options?: any): Promise<T>;
    /**
