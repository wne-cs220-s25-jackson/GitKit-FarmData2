...
export declare class ElectronMainMenuFactory extends BrowserMainMenuFactory {
    ...
    protected toggledCommands: Set<string>;
    ...
    protected fillMenuTemplate(parentItems: MenuDto[], menu: MenuNode, args: unknown[] | undefined, options: ElectronMenuOptions, skipRoot: boolean): MenuDto[];
