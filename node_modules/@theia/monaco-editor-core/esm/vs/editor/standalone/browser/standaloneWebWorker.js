...
class MonacoWebWorkerImpl extends editorWorkerService_js_1.EditorWorkerClient {
    constructor(modelService, opts) {
        const workerDescriptor = {
            moduleId: standaloneServices_js_1.standaloneEditorWorkerDescriptor.moduleId,
            esmModuleLocation: standaloneServices_js_1.standaloneEditorWorkerDescriptor.esmModuleLocation,
            label: opts.label,
        };
    ...
    _getForeignProxy() {
        if (!this._foreignProxy) {
            this._foreignProxy = this._getProxy().then((proxy) => {
                const foreignHostMethods = this._foreignModuleHost ? (0, objects_js_1.getAllMethodNames)(this._foreignModuleHost) : [];
