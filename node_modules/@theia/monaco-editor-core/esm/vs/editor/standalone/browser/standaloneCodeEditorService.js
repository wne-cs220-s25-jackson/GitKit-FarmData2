...
const abstractCodeEditorService_js_1 = require("../../browser/services/abstractCodeEditorService.js");
...
let StandaloneCodeEditorService = class StandaloneCodeEditorService extends abstractCodeEditorService_js_1.AbstractCodeEditorService {
    ...
    doOpenEditor(editor, input) {
        ...
        if (!model) {
            if (input.resource) {
                ...
                if (schema === network_js_1.Schemas.http || schema === network_js_1.Schemas.https) {
                    // This is a fully qualified http or https URL
                    (0, dom_js_1.windowOpenNoOpener)(input.resource.toString());
                    return editor;
                }
            }
            return null;
...
(0, extensions_js_1.registerSingleton)(codeEditorService_js_1.ICodeEditorService, StandaloneCodeEditorService, 0 /* InstantiationType.Eager */);
