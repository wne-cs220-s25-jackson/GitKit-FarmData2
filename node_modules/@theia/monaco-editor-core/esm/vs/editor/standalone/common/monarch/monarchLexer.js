...
const monarchCommon = require("./monarchCommon.js");
...
let MonarchTokenizer = MonarchTokenizer_1 = class MonarchTokenizer extends lifecycle_js_1.Disposable {
    ...
    tokenize(line, hasEOL, lineState) {
        if (line.length >= this._maxTokenizationLineLength) {
            return (0, nullTokenize_js_1.nullTokenize)(this._languageId, lineState);
        }
    ...
    tokenizeEncoded(line, hasEOL, lineState) {
        if (line.length >= this._maxTokenizationLineLength) {
            return (0, nullTokenize_js_1.nullTokenizeEncoded)(this._languageService.languageIdCodec.encodeLanguageId(this._languageId), lineState);
        }
    ...
    _getNestedEmbeddedLanguageData(languageId) {
        if (!this._languageService.isRegisteredLanguageId(languageId)) {
            return new EmbeddedLanguageData(languageId, nullTokenize_js_1.NullState);
        }
...
exports.MonarchTokenizer = MonarchTokenizer = MonarchTokenizer_1 = __decorate([
    __param(4, configuration_js_1.IConfigurationService)
], MonarchTokenizer);
/**
