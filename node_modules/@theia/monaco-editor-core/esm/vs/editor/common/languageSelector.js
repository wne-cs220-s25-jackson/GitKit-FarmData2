    ...
    if (Array.isArray(selector)) {
        ...
        if (pattern) {
            ...
            if (typeof pattern === 'string') {
                ...
                normalizedPattern = { ...pattern, base: (0, path_js_1.normalize)(pattern.base) };
            }
            if (normalizedPattern === candidateUri.fsPath || (0, glob_js_1.match)(normalizedPattern, candidateUri.fsPath)) {
                ret = 10;
            }
            else {
                return 0;
