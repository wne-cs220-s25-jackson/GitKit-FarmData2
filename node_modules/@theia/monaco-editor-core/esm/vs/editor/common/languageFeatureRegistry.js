...
const languageSelector_js_1 = require("./languageSelector.js");
...
class LanguageFeatureRegistry {
    ...
    _updateScores(model, recursive) {
        ...
        for (const entry of this._entries) {
            entry._score = (0, languageSelector_js_1.score)(entry.selector, candidate.uri, candidate.languageId, (0, model_js_1.shouldSynchronizeModel)(model), candidate.notebookUri, candidate.notebookType);
