...
const characterClassifier_js_1 = require("../core/characterClassifier.js");
const textModelEvents_js_1 = require("../textModelEvents.js");
const modelLineProjectionData_js_1 = require("../modelLineProjectionData.js");
...
class WrappingCharacterClassifier extends characterClassifier_js_1.CharacterClassifier {
...
function createLineBreaks(classifier, _lineText, injectedTexts, tabSize, firstLineBreakColumn, columnsForFullWidthChar, wrappingIndent, wordBreak) {
    const lineText = textModelEvents_js_1.LineInjectedText.applyInjectedText(_lineText, injectedTexts);
    ...
    return new modelLineProjectionData_js_1.ModelLineProjectionData(injectionOffsets, injectionOptions, breakingOffsets, breakingOffsetsVisibleColumn, wrappedTextIndentLength);
}
