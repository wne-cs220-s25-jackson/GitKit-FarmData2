...
class ModelLineProjection {
    ...
    getViewLineContent(model, modelLineNumber, outputLineIndex) {
        ...
        if (this._projectionData.injectionOffsets !== null) {
            const injectedTexts = this._projectionData.injectionOffsets.map((offset, idx) => new textModelEvents_js_1.LineInjectedText(0, 0, offset + 1, this._projectionData.injectionOptions[idx], 0));
            const lineWithInjections = textModelEvents_js_1.LineInjectedText.applyInjectedText(model.getLineContent(modelLineNumber), injectedTexts);
    ...
    */
                ...
                while (currentInjectedOffset < injectionOffsets.length) {
                    ...
                    if (lineStartOffsetInInputWithInjections < injectedTextEndOffsetInInputWithInjections) {
                        ...
                        if (options.inlineClassName) {
                            ...
                            if (start !== end) {
                                inlineDecorations.push(new viewModel_js_1.SingleLineInlineDecoration(start, end, options.inlineClassName, options.inlineClassNameAffectsLetterSpacing));
                            }
                        }
                    }
            ...
            for (let idx = 0; idx < injectionOffsets.length; idx++) {
                ...
                if (tokens) {
                    ...
                    tokensToInsert.push({
                        ...
                        tokenMetadata: lineTokens_js_1.LineTokens.defaultTokenMetadata,
                    });
                }
            }
    ...
    _getViewLineData(lineWithInjections, inlineDecorations, outputLineIndex) {
        ...
        return new viewModel_js_1.ViewLineData(lineContent, continuesWithWrappedLine, minColumn, maxColumn, startVisibleColumn, tokens, inlineDecorations);
    }
...
class IdentityModelLineProjection {
    ...
    getViewPositionOfModelPosition(deltaLineNumber, inputColumn) {
        return new position_js_1.Position(deltaLineNumber, inputColumn);
    }
