...
class SparseMultilineTokens {
    ...
    getRange() {
        ...
        return new range_js_1.Range(this._startLineNumber + deltaRange.startLineNumber, deltaRange.startColumn, this._startLineNumber + deltaRange.endLineNumber, deltaRange.endColumn);
    }
    removeTokens(range) {
    ...
    acceptEdit(range, eolCount, firstLineLength, lastLineLength, firstCharCode) {
        ...
        this._acceptInsertText(new position_js_1.Position(range.startLineNumber, range.startColumn), eolCount, firstLineLength, lastLineLength, firstCharCode);
        this._updateEndLineNumber();
    }
...
class SparseMultilineTokensStorage {
    ...
    getRange() {
        ...
        return new range_js_1.Range(0, startChar + 1, maxDeltaLine, endChar + 1);
    }
    _getTokenCount() {
