...
const contiguousMultilineTokens_js_1 = require("./contiguousMultilineTokens.js");
class ContiguousMultilineTokensBuilder {
    static deserialize(buff) {
        ...
        for (let i = 0; i < count; i++) {
            offset = contiguousMultilineTokens_js_1.ContiguousMultilineTokens.deserialize(buff, offset, result);
        }
        return result;
    }
    constructor() {
    ...
    add(lineNumber, lineTokens) {
        ...
        this._tokens.push(new contiguousMultilineTokens_js_1.ContiguousMultilineTokens(lineNumber, [lineTokens]));
    }
    finalize() {
        return this._tokens;
    }
