...
class ContiguousTokensEditing {
    ...
    static delete(lineTokens, fromChIndex, toChIndex) {
        ...
        const fromTokenIndex = lineTokens_js_1.LineTokens.findIndexInTokensArray(tokens, fromChIndex);
    ...
    static insert(lineTokens, chIndex, textLength) {
        ...
        const tokens = toUint32Array(lineTokens);
        const tokensCount = (tokens.length >>> 1);
        let fromTokenIndex = lineTokens_js_1.LineTokens.findIndexInTokensArray(tokens, chIndex);
        if (fromTokenIndex > 0) {
