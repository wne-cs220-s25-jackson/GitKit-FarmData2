...
class SingleLineInlineDecoration {
    ...
    toInlineDecoration(lineNumber) {
        return new InlineDecoration(new range_js_1.Range(lineNumber, this.startOffset + 1, lineNumber, this.endOffset + 1), this.inlineClassName, this.inlineClassNameAffectsLetterSpacing ? 3 /* InlineDecorationType.RegularAffectingLetterSpacing */ : 0 /* InlineDecorationType.Regular */);
    }
}
