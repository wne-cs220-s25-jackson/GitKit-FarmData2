...
class ModelLineProjectionData {
    ...
    normalizeOffsetInInputWithInjectionsAroundInjections(offsetInInputWithInjections, affinity) {
        ...
        (0, assert_js_1.assertNever)(affinity);
    }
...
function hasRightCursorStop(cursorStop) {
    ...
    return cursorStop === model_js_1.InjectedTextCursorStops.Right || cursorStop === model_js_1.InjectedTextCursorStops.Both;
}
function hasLeftCursorStop(cursorStop) {
    if (cursorStop === null || cursorStop === undefined) {
        return true;
    }
    return cursorStop === model_js_1.InjectedTextCursorStops.Left || cursorStop === model_js_1.InjectedTextCursorStops.Both;
}
class InjectedText {
    constructor(options) {
...
class OutputPosition {
    ...
    toPosition(baseLineNumber) {
        return new position_js_1.Position(baseLineNumber + this.outputLineIndex, this.outputOffset + 1);
    }
}
