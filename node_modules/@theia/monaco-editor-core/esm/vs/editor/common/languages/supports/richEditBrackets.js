...
const stringBuilder = require("../../core/stringBuilder.js");
...
class BracketsUtils {
    static _findPrevBracketInText(reversedBracketRegex, lineNumber, reversedText, offset) {
        ...
        return new range_js_1.Range(lineNumber, absoluteMatchOffset - matchLength + 1, lineNumber, absoluteMatchOffset + 1);
    }
    ...
    static findNextBracketInText(bracketRegex, lineNumber, text, offset) {
        ...
        const absoluteMatchOffset = offset + matchOffset;
        return new range_js_1.Range(lineNumber, absoluteMatchOffset + 1, lineNumber, absoluteMatchOffset + 1 + matchLength);
    }
