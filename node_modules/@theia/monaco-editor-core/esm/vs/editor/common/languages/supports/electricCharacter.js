...
const richEditBrackets_js_1 = require("./richEditBrackets.js");
class BracketElectricCharacterSupport {
    ...
    getElectricCharacters() {
        ...
        return (0, arrays_js_1.distinct)(result);
    }
    onElectricCharacter(character, context, column) {
        ...
        if ((0, supports_js_1.ignoreBracketsInToken)(context.getStandardTokenType(tokenIndex))) {
            return null;
        }
        const reversedBracketRegex = this._richEditBrackets.reversedRegex;
        const text = context.getLineContent().substring(0, column - 1) + character;
        const r = richEditBrackets_js_1.BracketsUtils.findPrevBracketInRange(reversedBracketRegex, 1, text, 0, text.length);
        if (!r) {
            return null;
        }
