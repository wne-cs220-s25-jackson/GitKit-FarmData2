...
class IndentationContextProcessor {
    ...
    _getProcessedTokensBeforeRange(range) {
        ...
        const scopedLineTokens = (0, supports_js_1.createScopedLineTokens)(lineTokens, range.startColumn - 1);
        let slicedTokens;
    ...
    _getProcessedTokensAfterRange(range) {
        ...
        const scopedLineTokens = (0, supports_js_1.createScopedLineTokens)(lineTokens, position.column - 1);
    ...
    _getProcessedPreviousLineTokens(range) {
        const getScopedLineTokensAtEndColumnOfLine = (lineNumber) => {
            ...
            const scopedLineTokensAtEndColumn = (0, supports_js_1.createScopedLineTokens)(lineTokens, endColumnOfLine);
            return scopedLineTokensAtEndColumn;
        };
        this.model.tokenization.forceTokenization(range.startLineNumber);
        const lineTokens = this.model.tokenization.getLineTokens(range.startLineNumber);
        const scopedLineTokens = (0, supports_js_1.createScopedLineTokens)(lineTokens, range.startColumn - 1);
        const emptyTokens = lineTokens_js_1.LineTokens.createEmpty('', scopedLineTokens.languageIdCodec);
...
class IndentationLineProcessor {
    ...
    getProcessedTokens(tokens) {
        ...
        const processedLineTokens = lineTokens_js_1.LineTokens.createFromTextAndMetadata(textAndMetadata, tokens.languageIdCodec);
