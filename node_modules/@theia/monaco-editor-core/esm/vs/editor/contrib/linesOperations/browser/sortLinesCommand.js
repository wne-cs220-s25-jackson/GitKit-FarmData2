...
function sortLines(model, selection, descending) {
    ...
    return editOperation_js_1.EditOperation.replace(new range_js_1.Range(data.startLineNumber, 1, data.endLineNumber, model.getLineMaxColumn(data.endLineNumber)), data.after.join('\n'));
}
