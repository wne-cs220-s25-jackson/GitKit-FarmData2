...
const keybindingCancellation_js_1 = require("./keybindingCancellation.js");
class EditorState {
 ...
 */
class EditorStateCancellationTokenSource extends keybindingCancellation_js_1.EditorKeybindingCancellationTokenSource {
    constructor(editor, flags, range, parent) {
        super(editor, parent);
        this._listener = new lifecycle_js_1.DisposableStore();
        if (flags & 4 /* CodeEditorStateFlag.Position */) {
            this._listener.add(editor.onDidChangeCursorPosition(e => {
                if (!range || !range_js_1.Range.containsPosition(range, e.position)) {
                    this.cancel();
                }
            }));
        }
        if (flags & 2 /* CodeEditorStateFlag.Selection */) {
            this._listener.add(editor.onDidChangeCursorSelection(e => {
                if (!range || !range_js_1.Range.containsRange(range, e.selection)) {
                    this.cancel();
                }
            }));
        }
 ...
 */
class TextModelCancellationTokenSource extends cancellation_js_1.CancellationTokenSource {
