...
const stickyScrollWidget_js_1 = require("./stickyScrollWidget.js");
const stickyScrollProvider_js_1 = require("./stickyScrollProvider.js");
...
const clickLinkGesture_js_1 = require("../../gotoSymbol/browser/link/clickLinkGesture.js");
const range_js_1 = require("../../../common/core/range.js");
const goToSymbol_js_1 = require("../../gotoSymbol/browser/goToSymbol.js");
const inlayHintsLocations_js_1 = require("../../inlayHints/browser/inlayHintsLocations.js");
...
const stickyScrollElement_js_1 = require("./stickyScrollElement.js");
const mouseEvent_js_1 = require("../../../../base/browser/mouseEvent.js");
const folding_js_1 = require("../../folding/browser/folding.js");
const foldingModel_js_1 = require("../../folding/browser/foldingModel.js");
let StickyScrollController = class StickyScrollController extends lifecycle_js_1.Disposable {
    ...
    constructor(_editor, _contextMenuService, _languageFeaturesService, _instaService, _languageConfigurationService, _languageFeatureDebounceService, _contextKeyService) {
        ...
        this._sessionStore = new lifecycle_js_1.DisposableStore();
        ...
        this._stickyScrollWidget = new stickyScrollWidget_js_1.StickyScrollWidget(this._editor);
        this._stickyLineCandidateProvider = new stickyScrollProvider_js_1.StickyLineCandidateProvider(this._editor, _languageFeaturesService, _languageConfigurationService);
        this._register(this._stickyScrollWidget);
        this._register(this._stickyLineCandidateProvider);
        this._widgetState = stickyScrollWidget_js_1.StickyScrollWidgetState.Empty;
        ...
        this._stickyScrollFocusedContextKey = editorContextKeys_js_1.EditorContextKeys.stickyScrollFocused.bindTo(this._contextKeyService);
        this._stickyScrollVisibleContextKey = editorContextKeys_js_1.EditorContextKeys.stickyScrollVisible.bindTo(this._contextKeyService);
    ...
    focus() {
        ...
        this._focused = true;
        this._focusDisposableStore = new lifecycle_js_1.DisposableStore();
    ...
    _reveaInEditor(position, revealFunction) {
        ...
        revealFunction();
        this._editor.setSelection(range_js_1.Range.fromPositions(position));
        this._editor.focus();
    }
    _registerMouseListeners() {
        const sessionStore = this._register(new lifecycle_js_1.DisposableStore());
        const gesture = this._register(new clickLinkGesture_js_1.ClickLinkGesture(this._editor, {
        ...
        const getMouseEventTarget = (mouseEvent) => {
            ...
            return {
                range: new range_js_1.Range(position.lineNumber, position.column, position.lineNumber, position.column + mouseTargetElement.innerText.length),
        ...
        this._register(dom.addStandardDisposableListener(stickyScrollWidgetDomNode, dom.EventType.CLICK, (mouseEvent) => {
            ...
            if (mouseEvent.shiftKey) {
                ...
                const position = new position_js_1.Position(this._endLineNumbers[lineIndex], 1);
            ...
            if (!position) {
                ...
                position = new position_js_1.Position(lineNumber, 1);
            }
        ...
        this._register(gesture.onMouseMoveOrRelevantKeyDown(([mouseEvent, _keyboardEvent]) => {
            ...
            const cancellationToken = new cancellation_js_1.CancellationTokenSource();
            sessionStore.add((0, lifecycle_js_1.toDisposable)(() => cancellationToken.dispose(true)));
            let currentHTMLChild;
            (0, goToSymbol_js_1.getDefinitionsAtPosition)(this._languageFeaturesService.definitionProvider, this._editor.getModel(), new position_js_1.Position(range.startLineNumber, range.startColumn + 1), false, cancellationToken.token).then((candidateDefinitions => {
                ...
                if (candidateDefinitions.length !== 0) {
                    ...
                    if (currentHTMLChild !== childHTML) {
                        ...
                        sessionStore.add((0, lifecycle_js_1.toDisposable)(() => {
        ...
        this._register(gesture.onExecute(async (e) => {
            ...
            this._instaService.invokeFunction(inlayHintsLocations_js_1.goToDefinitionWithLocation, e, this._editor, { uri: this._editor.getModel().uri, range: this._stickyRangeProjectedOnEditor });
        }));
    }
    _onContextMenu(targetWindow, e) {
        const event = new mouseEvent_js_1.StandardMouseEvent(targetWindow, e);
        this._contextMenuService.showContextMenu({
            menuId: actions_js_1.MenuId.StickyScrollContext,
            getAnchor: () => event,
        });
    }
    _toggleFoldingRegionForLine(line) {
        ...
        (0, foldingModel_js_1.toggleCollapseState)(this._foldingModel, Number.MAX_VALUE, [line]);
    ...
    async _updateState(rebuildFromLine) {
        ...
        this._foldingModel = await folding_js_1.FoldingController.get(this._editor)?.getFoldingModel() ?? undefined;
    ...
    findScrollWidgetState() {
        ...
        if (arrayVisibleRanges.length !== 0) {
            const fullVisibleRange = new stickyScrollElement_js_1.StickyRange(arrayVisibleRanges[0].startLineNumber, arrayVisibleRanges[arrayVisibleRanges.length - 1].endLineNumber);
        ...
        return new stickyScrollWidget_js_1.StickyScrollWidgetState(startLineNumbers, endLineNumbers, lastLineRelativePosition, this._showEndForLine);
    }
    dispose() {
        super.dispose();
...
exports.StickyScrollController = StickyScrollController = StickyScrollController_1 = __decorate([
    __param(1, contextView_js_1.IContextMenuService),
