...
const stickyScrollModelProvider_js_1 = require("./stickyScrollModelProvider.js");
...
let StickyLineCandidateProvider = class StickyLineCandidateProvider extends lifecycle_js_1.Disposable {
    ...
    constructor(editor, _languageFeaturesService, _languageConfigurationService) {
        ...
        this._onDidChangeStickyScroll = this._register(new event_js_1.Emitter());
        this.onDidChangeStickyScroll = this._onDidChangeStickyScroll.event;
        this._model = null;
        this._cts = null;
        this._stickyModelProvider = null;
        this._editor = editor;
        this._sessionStore = this._register(new lifecycle_js_1.DisposableStore());
        this._updateSoon = this._register(new async_js_1.RunOnceScheduler(() => this.update(), 50));
    ...
    readConfiguration() {
        ...
        this._sessionStore.add((0, lifecycle_js_1.toDisposable)(() => {
    ...
    updateStickyModelProvider() {
        ...
        if (editor.hasModel()) {
            this._stickyModelProvider = new stickyScrollModelProvider_js_1.StickyModelProvider(editor, () => this._updateSoon.schedule(), this._languageConfigurationService, this._languageFeaturesService);
        }
    }
    async update() {
        this._cts?.dispose(true);
        this._cts = new cancellation_js_1.CancellationTokenSource();
    ...
    getCandidateStickyLinesIntersectingFromStickyModel(range, outlineModel, result, depth, lastStartLineNumber) {
        ...
        const lowerBound = this.updateIndex((0, arrays_js_1.binarySearch)(childrenStartLines, range.startLineNumber, (a, b) => { return a - b; }));
        const upperBound = this.updateIndex((0, arrays_js_1.binarySearch)(childrenStartLines, range.startLineNumber + depth, (a, b) => { return a - b; }));
