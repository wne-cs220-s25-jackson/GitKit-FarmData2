...
const utils_js_1 = require("../../../common/model/utils.js");
...
class RangesCollector {
    ...
    insertFirst(startLineNumber, endLineNumber, indent) {
        if (startLineNumber > foldingRanges_js_1.MAX_LINE_NUMBER || endLineNumber > foldingRanges_js_1.MAX_LINE_NUMBER) {
            return;
        }
    ...
    toIndentRanges(model) {
        ...
        if (this._length <= limit) {
            ...
            return new foldingRanges_js_1.FoldingRegions(startIndexes, endIndexes);
        }
        else {
            ...
            for (let i = this._length - 1, k = 0; i >= 0; i--) {
                ...
                const indent = (0, utils_js_1.computeIndentLevel)(lineContent, tabSize);
