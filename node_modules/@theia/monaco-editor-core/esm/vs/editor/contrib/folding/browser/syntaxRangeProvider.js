...
class RangesCollector {
    ...
    toIndentRanges() {
        ...
        if (this._length <= limit) {
            ...
            return new foldingRanges_js_1.FoldingRegions(startIndexes, endIndexes, this._types);
        }
        else {
            ...
            return new foldingRanges_js_1.FoldingRegions(startIndexes, endIndexes, types);
        }
    }
}
