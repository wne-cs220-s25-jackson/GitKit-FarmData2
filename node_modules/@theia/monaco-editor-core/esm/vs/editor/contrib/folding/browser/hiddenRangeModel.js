...
const eolCounter_js_1 = require("../../../common/core/eolCounter.js");
    ...
    notifyChangeModelContent(e) {
        if (this._hiddenRanges.length && !this._hasLineChanges) {
            this._hasLineChanges = e.changes.some(change => {
                return change.range.endLineNumber !== change.range.startLineNumber || (0, eolCounter_js_1.countEOL)(change.text)[0] !== 0;
            });
        }
    }
    updateHiddenRanges() {
        ...
        for (; i < ranges.length; i++) {
            ...
            if (!updateHiddenAreas && k < this._hiddenRanges.length && this._hiddenRanges[k].startLineNumber === startLineNumber && this._hiddenRanges[k].endLineNumber === endLineNumber) {
                ...
                newHiddenAreas.push(new range_js_1.Range(startLineNumber, 1, endLineNumber, 1));
            }
...
function findRange(ranges, line) {
    const i = (0, arraysFind_js_1.findFirstIdxMonotonousOrArrLen)(ranges, r => line < r.startLineNumber) - 1;
