...
const foldingRanges_js_1 = require("./foldingRanges.js");
...
class FoldingModel {
    ...
    constructor(textModel, decorationProvider) {
        this._updateEventEmitter = new event_js_1.Emitter();
        this.onDidChange = this._updateEventEmitter.event;
        this._textModel = textModel;
        this._decorationProvider = decorationProvider;
        this._regions = new foldingRanges_js_1.FoldingRegions(new Uint32Array(0), new Uint32Array(0));
    ...
    removeManualRanges(ranges) {
        ...
        this.updatePost(foldingRanges_js_1.FoldingRegions.fromFoldRanges(newFoldingRanges));
    }
    update(newRegions, selection) {
        const foldedOrManualRanges = this._currentFoldedOrManualRanges(selection);
        const newRanges = foldingRanges_js_1.FoldingRegions.sanitizeAndMerge(newRegions, foldedOrManualRanges, this._textModel.getLineCount(), selection);
        this.updatePost(foldingRanges_js_1.FoldingRegions.fromFoldRanges(newRanges));
    }
    ...
    applyMemento(state) {
        ...
        const newRanges = foldingRanges_js_1.FoldingRegions.sanitizeAndMerge(this._regions, rangesToRestore, maxLineNumber);
        this.updatePost(foldingRanges_js_1.FoldingRegions.fromFoldRanges(newRanges));
    }
    _getLinesChecksum(lineNumber1, lineNumber2) {
        const h = (0, hash_js_1.hash)(this._textModel.getLineContent(lineNumber1)
