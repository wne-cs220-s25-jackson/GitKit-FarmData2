...
exports.CodeActionKind = new class {
    constructor() {
        this.QuickFix = new hierarchicalKind_js_1.HierarchicalKind('quickfix');
        this.Refactor = new hierarchicalKind_js_1.HierarchicalKind('refactor');
        ...
        this.Notebook = new hierarchicalKind_js_1.HierarchicalKind('notebook');
        this.Source = new hierarchicalKind_js_1.HierarchicalKind('source');
...
function filtersAction(filter, action) {
    const actionKind = action.kind ? new hierarchicalKind_js_1.HierarchicalKind(action.kind) : undefined;
...
class CodeActionCommandArgs {
    ...
    static getKindFromUser(arg, defaultKind) {
        return typeof arg.kind === 'string'
            ? new hierarchicalKind_js_1.HierarchicalKind(arg.kind)
            : defaultKind;
    }
