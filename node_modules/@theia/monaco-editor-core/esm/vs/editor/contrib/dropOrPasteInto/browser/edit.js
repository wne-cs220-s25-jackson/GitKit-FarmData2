...
function createCombinedWorkspaceEdit(uri, ranges, edit) {
    ...
    return {
        edits: [
            ...ranges.map(range => new bulkEditService_js_1.ResourceTextEdit(uri, { range, text: typeof edit.insertText === 'string' ? snippetParser_js_1.SnippetParser.escape(edit.insertText) + '$0' : edit.insertText.snippet, insertAsSnippet: true })),
