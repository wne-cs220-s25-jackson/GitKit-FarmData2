...
const unicodeTextModelHighlighter_js_1 = require("../../../common/services/unicodeTextModelHighlighter.js");
const editorWorker_js_1 = require("../../../common/services/editorWorker.js");
const language_js_1 = require("../../../common/languages/language.js");
const viewModelDecorations_js_1 = require("../../../common/viewModel/viewModelDecorations.js");
...
const bannerController_js_1 = require("./bannerController.js");
...
exports.warningIcon = (0, iconRegistry_js_1.registerIcon)('extensions-warning-message', codicons_js_1.Codicon.warning, nls.localize('warningIcon', 'Icon shown with a warning message in the extensions editor.'));
let UnicodeHighlighter = class UnicodeHighlighter extends lifecycle_js_1.Disposable {
    ...
    constructor(_editor, _editorWorkerService, _workspaceTrustService, instantiationService) {
        ...
        this._bannerController = this._register(instantiationService.createInstance(bannerController_js_1.BannerController, _editor));
...
exports.UnicodeHighlighter = UnicodeHighlighter = __decorate([
    ...
    __param(2, workspaceTrust_js_1.IWorkspaceTrustManagementService),
    __param(3, instantiation_js_1.IInstantiationService)
], UnicodeHighlighter);
function resolveOptions(trusted, options) {
    return {
        nonBasicASCII: options.nonBasicASCII === editorOptions_js_1.inUntrustedWorkspace ? !trusted : options.nonBasicASCII,
        ambiguousCharacters: options.ambiguousCharacters,
        invisibleCharacters: options.invisibleCharacters,
        includeComments: options.includeComments === editorOptions_js_1.inUntrustedWorkspace ? !trusted : options.includeComments,
        includeStrings: options.includeStrings === editorOptions_js_1.inUntrustedWorkspace ? !trusted : options.includeStrings,
        allowedCharacters: options.allowedCharacters,
        allowedLocales: options.allowedLocales,
    };
}
let DocumentUnicodeHighlighter = class DocumentUnicodeHighlighter extends lifecycle_js_1.Disposable {
    constructor(_editor, _options, _updateState, _editorWorkerService) {
        ...
        this._updateSoon = this._register(new async_js_1.RunOnceScheduler(() => this._update(), 250));
    ...
    getDecorationInfo(decoration) {
        ...
        if (!(0, viewModelDecorations_js_1.isModelDecorationVisible)(model, decoration)) {
            return null;
        }
        const text = model.getValueInRange(decoration.range);
        return {
            reason: computeReason(text, this._options),
            inComment: (0, viewModelDecorations_js_1.isModelDecorationInComment)(model, decoration),
            inString: (0, viewModelDecorations_js_1.isModelDecorationInString)(model, decoration),
        };
    }
};
DocumentUnicodeHighlighter = __decorate([
    __param(3, editorWorker_js_1.IEditorWorkerService)
], DocumentUnicodeHighlighter);
class ViewportUnicodeHighlighter extends lifecycle_js_1.Disposable {
    ...
    _update() {
        ...
        for (const range of ranges) {
            const result = unicodeTextModelHighlighter_js_1.UnicodeTextModelHighlighter.computeUnicodeHighlights(this._model, this._options, range);
        ...
        for (const d of lineDecorations) {
            ...
            switch (highlightInfo.reason.kind) {
                case 0 /* UnicodeHighlighterReasonKind.Ambiguous */: {
                    if ((0, strings_js_1.isBasicASCII)(highlightInfo.reason.confusableWith)) {
            ...
            const markdown = new htmlContent_js_1.MarkdownString('', true)
                .appendMarkdown(reason)
                .appendText(' ')
                .appendLink(uri, adjustSettings, configureUnicodeHighlightOptionsStr);
            result.push(new markdownHoverParticipant_js_1.MarkdownHover(this, d.range, [markdown], false, index++));
        }
        return result;
    }
    renderHoverParts(context, hoverParts) {
        return (0, markdownHoverParticipant_js_1.renderMarkdownHovers)(context, hoverParts, this._editor, this._languageService, this._openerService);
    }
...
function formatCodePointMarkdown(codePoint) {
    ...
    if (!strings_js_1.InvisibleCharacters.isInvisibleCharacter(codePoint)) {
...
function computeReason(char, options) {
    return unicodeTextModelHighlighter_js_1.UnicodeTextModelHighlighter.computeUnicodeHighlightReason(char, options);
}
class Decorations {
    constructor() {
        this.map = new Map();
    ...
    getDecoration(hideInComments, hideInStrings) {
        ...
        if (!options) {
            options = textModel_js_1.ModelDecorationOptions.createDynamic({
...
class DisableHighlightingInCommentsAction extends editorExtensions_js_1.EditorAction {
    ...
    async runAction(configurationService) {
        await configurationService.updateValue(editorOptions_js_1.unicodeHighlightConfigKeys.includeComments, false, 2 /* ConfigurationTarget.USER */);
    }
}
exports.DisableHighlightingInCommentsAction = DisableHighlightingInCommentsAction;
class DisableHighlightingInStringsAction extends editorExtensions_js_1.EditorAction {
    ...
    async runAction(configurationService) {
        await configurationService.updateValue(editorOptions_js_1.unicodeHighlightConfigKeys.includeStrings, false, 2 /* ConfigurationTarget.USER */);
    }
}
exports.DisableHighlightingInStringsAction = DisableHighlightingInStringsAction;
class DisableHighlightingOfAmbiguousCharactersAction extends editorExtensions_js_1.EditorAction {
    ...
    async runAction(configurationService) {
        await configurationService.updateValue(editorOptions_js_1.unicodeHighlightConfigKeys.ambiguousCharacters, false, 2 /* ConfigurationTarget.USER */);
    }
}
exports.DisableHighlightingOfAmbiguousCharactersAction = DisableHighlightingOfAmbiguousCharactersAction;
class DisableHighlightingOfInvisibleCharactersAction extends editorExtensions_js_1.EditorAction {
    ...
    async runAction(configurationService) {
        await configurationService.updateValue(editorOptions_js_1.unicodeHighlightConfigKeys.invisibleCharacters, false, 2 /* ConfigurationTarget.USER */);
    }
}
exports.DisableHighlightingOfInvisibleCharactersAction = DisableHighlightingOfInvisibleCharactersAction;
class DisableHighlightingOfNonBasicAsciiCharactersAction extends editorExtensions_js_1.EditorAction {
    ...
    async runAction(configurationService) {
        await configurationService.updateValue(editorOptions_js_1.unicodeHighlightConfigKeys.nonBasicASCII, false, 2 /* ConfigurationTarget.USER */);
    }
}
exports.DisableHighlightingOfNonBasicAsciiCharactersAction = DisableHighlightingOfNonBasicAsciiCharactersAction;
class ShowExcludeOptions extends editorExtensions_js_1.EditorAction {
    ...
    async run(accessor, editor, args) {
        ...
        const quickPickService = accessor.get(quickInput_js_1.IQuickInputService);
        const configurationService = accessor.get(configuration_js_1.IConfigurationService);
...
async function excludeCharFromBeingHighlighted(configurationService, charCodes) {
    const existingValue = configurationService.getValue(editorOptions_js_1.unicodeHighlightConfigKeys.allowedCharacters);
    let value;
    ...
    await configurationService.updateValue(editorOptions_js_1.unicodeHighlightConfigKeys.allowedCharacters, value, 2 /* ConfigurationTarget.USER */);
}
async function excludeLocaleFromBeingHighlighted(configurationService, locales) {
    const existingValue = configurationService.inspect(editorOptions_js_1.unicodeHighlightConfigKeys.allowedLocales).user?.value;
    let value;
    if ((typeof existingValue === 'object') && existingValue) {
    ...
    await configurationService.updateValue(editorOptions_js_1.unicodeHighlightConfigKeys.allowedLocales, value, 2 /* ConfigurationTarget.USER */);
}
function expectNever(value) {
    throw new Error(`Unexpected value: ${value}`);
}
(0, editorExtensions_js_1.registerEditorAction)(DisableHighlightingOfAmbiguousCharactersAction);
(0, editorExtensions_js_1.registerEditorAction)(DisableHighlightingOfInvisibleCharactersAction);
(0, editorExtensions_js_1.registerEditorAction)(DisableHighlightingOfNonBasicAsciiCharactersAction);
(0, editorExtensions_js_1.registerEditorAction)(ShowExcludeOptions);
(0, editorExtensions_js_1.registerEditorContribution)(UnicodeHighlighter.ID, UnicodeHighlighter, 1 /* EditorContributionInstantiation.AfterFirstRender */);
hoverTypes_js_1.HoverParticipantRegistry.register(UnicodeHighlighterHoverParticipant);
