...
const $ = dom.$;
class SaturationBox extends lifecycle_js_1.Disposable {
    ...
    onPointerDown(e) {
        ...
        this.monitor = this._register(new globalPointerMoveMonitor_js_1.GlobalPointerMoveMonitor());
    ...
    paint() {
        const hsva = this.model.color.hsva;
        const saturatedColor = new color_js_1.Color(new color_js_1.HSVA(hsva.h, 1, 1, 1));
        ...
        ctx.fillStyle = color_js_1.Color.Format.CSS.format(saturatedColor);
        ctx.fill();
...
exports.SaturationBox = SaturationBox;
