...
exports.ColorPickerHeader = void 0;
...
const colorPickerCloseButton_js_1 = require("./colorPickerCloseButton.js");
const $ = dom.$;
class ColorPickerHeader extends lifecycle_js_1.Disposable {
    constructor(container, model, themeService, type) {
        ...
        const tooltip = (0, nls_js_1.localize)('clickToToggleColorOptions', "Click to toggle color options (rgb/hsl/hex)");
        this._pickedColorNode.setAttribute('title', tooltip);
        this._originalColorNode = dom.append(this._domNode, $('.original-color'));
        this._originalColorNode.style.backgroundColor = color_js_1.Color.Format.CSS.format(this.model.originalColor) || '';
        this.backgroundColor = themeService.getColorTheme().getColor(colorRegistry_js_1.editorHoverBackground) || color_js_1.Color.white;
        this._register(themeService.onDidColorThemeChange(theme => {
            this.backgroundColor = theme.getColor(colorRegistry_js_1.editorHoverBackground) || color_js_1.Color.white;
        }));
        ...
        this._pickedColorNode.style.backgroundColor = color_js_1.Color.Format.CSS.format(model.color) || '';
        ...
        if (this.type === "standalone" /* ColorPickerWidgetType.Standalone */) {
            ...
            this._closeButton = this._register(new colorPickerCloseButton_js_1.CloseButton(this._domNode));
        }
    }
    get domNode() {
    ...
    onDidChangeColor(color) {
        this._pickedColorNode.style.backgroundColor = color_js_1.Color.Format.CSS.format(color) || '';
