...
const characterClassifier_js_1 = require("../../../common/core/characterClassifier.js");
const languages = require("../../../common/languages.js");
const provideSignatureHelp_js_1 = require("./provideSignatureHelp.js");
...
class ParameterHintsModel extends lifecycle_js_1.Disposable {
    static { this.DEFAULT_DELAY = 120; } // ms
    constructor(editor, providers, delay = ParameterHintsModel.DEFAULT_DELAY) {
        super();
        this._onChangedHints = this._register(new event_js_1.Emitter());
        this.onChangedHints = this._onChangedHints.event;
        this.triggerOnType = false;
        this._state = ParameterHintState.Default;
        this._pendingTriggers = [];
        this._lastSignatureHelpResult = this._register(new lifecycle_js_1.MutableDisposable());
        this.triggerChars = new characterClassifier_js_1.CharacterSet();
        this.retriggerChars = new characterClassifier_js_1.CharacterSet();
        this.triggerId = 0;
        this.editor = editor;
        this.providers = providers;
        this.throttledDelayer = new async_js_1.Delayer(delay);
    ...
    async doTrigger(triggerId) {
        ...
        this.state = new ParameterHintState.Pending((0, async_js_1.createCancelablePromise)(token => (0, provideSignatureHelp_js_1.provideSignatureHelp)(this.providers, model, position, triggerContext, token)), activeSignatureHelp);
        try {
