...
const indentUtils = require("../common/indentUtils.js");
...
const indentation_js_1 = require("../common/indentation.js");
const lineTokens_js_1 = require("../../../common/tokens/lineTokens.js");
class IndentationToSpacesAction extends editorExtensions_js_1.EditorAction {
...
class IndentationToTabsAction extends editorExtensions_js_1.EditorAction {
...
class ChangeIndentationSizeAction extends editorExtensions_js_1.EditorAction {
    ...
    run(accessor, editor) {
        ...
        const modelService = accessor.get(model_js_1.IModelService);
        const model = editor.getModel();
        if (!model) {
            return;
        }
...
class DetectIndentation extends editorExtensions_js_1.EditorAction {
...
class ReindentLinesAction extends editorExtensions_js_1.EditorAction {
    constructor() {
        super({
    ...
    run(accessor, editor) {
        ...
        const edits = (0, indentation_js_1.getReindentEditOperations)(model, languageConfigurationService, 1, model.getLineCount());
        if (edits.length > 0) {
            editor.pushUndoStop();
...
class ReindentSelectedLinesAction extends editorExtensions_js_1.EditorAction {
    constructor() {
        super({
    ...
    run(accessor, editor) {
        ...
        for (const selection of selections) {
            ...
            const editOperations = (0, indentation_js_1.getReindentEditOperations)(model, languageConfigurationService, startLineNumber, endLineNumber);
...
class AutoIndentOnPasteCommand {
    ...
    getEditOperations(model, builder) {
        for (const edit of this._edits) {
            builder.addEditOperation(range_js_1.Range.lift(edit.range), edit.text);
        }
...
let AutoIndentOnPaste = class AutoIndentOnPaste {
    ...
    constructor(editor, _languageConfigurationService) {
        ...
        this.callOnDispose = new lifecycle_js_1.DisposableStore();
        this.callOnModel = new lifecycle_js_1.DisposableStore();
    ...
    trigger(range) {
        ...
        if (!/\S/.test(firstLineText.substring(0, range.startColumn - 1))) {
            const indentOfFirstLine = (0, autoIndent_js_1.getGoodIndentForLine)(autoIndent, model, model.getLanguageId(), startLineNumber, indentConverter, this._languageConfigurationService);
            if (indentOfFirstLine !== null) {
                ...
                if (newSpaceCnt !== oldSpaceCnt) {
                    ...
                    textEdits.push({
                        range: new range_js_1.Range(startLineNumber, 1, startLineNumber, oldIndentation.length + 1),
                        text: newIndent
                    });
                    firstLineText = newIndent + firstLineText.substring(oldIndentation.length);
                }
                else {
                    const indentMetadata = (0, autoIndent_js_1.getIndentMetadata)(model, startLineNumber, this._languageConfigurationService);
        ...
        if (startLineNumber !== range.endLineNumber) {
            ...
            const indentOfSecondLine = (0, autoIndent_js_1.getGoodIndentForLine)(autoIndent, virtualModel, model.getLanguageId(), startLineNumber + 1, indentConverter, this._languageConfigurationService);
                ...
                if (newSpaceCntOfSecondLine !== oldSpaceCntOfSecondLine) {
                    ...
                    for (let i = startLineNumber + 1; i <= range.endLineNumber; i++) {
                        ...
                        if (newIndent !== originalIndent) {
                            textEdits.push({
                                range: new range_js_1.Range(i, 1, i, originalIndent.length + 1),
                                text: newIndent
                            });
                        }
                    }
...
exports.AutoIndentOnPaste = AutoIndentOnPaste = __decorate([
    __param(1, languageConfigurationRegistry_js_1.ILanguageConfigurationService)
], AutoIndentOnPaste);
function isStartOrEndInString(model, range) {
    const isPositionInString = (position) => {
        const tokenType = (0, lineTokens_js_1.getStandardTokenTypeAtPosition)(model, position);
...
function getIndentationEditOperations(model, builder, tabSize, tabsToSpaces) {
    ...
    for (let lineNumber = 1, lineCount = model.getLineCount(); lineNumber <= lineCount; lineNumber++) {
        ...
        const originalIndentationRange = new range_js_1.Range(lineNumber, 1, lineNumber, lastIndentationColumn);
...
(0, editorExtensions_js_1.registerEditorContribution)(AutoIndentOnPaste.ID, AutoIndentOnPaste, 2 /* EditorContributionInstantiation.BeforeFirstInteraction */);
(0, editorExtensions_js_1.registerEditorAction)(IndentationToSpacesAction);
(0, editorExtensions_js_1.registerEditorAction)(IndentationToTabsAction);
(0, editorExtensions_js_1.registerEditorAction)(IndentUsingTabs);
(0, editorExtensions_js_1.registerEditorAction)(IndentUsingSpaces);
(0, editorExtensions_js_1.registerEditorAction)(ChangeTabDisplaySize);
(0, editorExtensions_js_1.registerEditorAction)(DetectIndentation);
(0, editorExtensions_js_1.registerEditorAction)(ReindentLinesAction);
(0, editorExtensions_js_1.registerEditorAction)(ReindentSelectedLinesAction);
