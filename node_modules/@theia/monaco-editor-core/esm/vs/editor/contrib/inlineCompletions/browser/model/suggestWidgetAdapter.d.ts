...
export declare class ObservableSuggestWidgetAdapter extends Disposable {
    ...
    readonly selectedItem: import("../../../../../base/common/observable.js").IObservable<SuggestItemInfo | undefined, unknown>;
    constructor(_editorObs: ObservableCodeEditor, _handleSuggestAccepted: (item: SuggestItemInfo) => void, _suggestControllerPreselector: () => SingleTextEdit | undefined);
    stopForceRenderingAbove(): void;
    forceRenderingAbove(): void;
}
