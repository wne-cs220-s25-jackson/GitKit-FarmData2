...
class LRUMemory extends Memory {
    constructor() {
        super('recentlyUsed');
        this._cache = new map_js_1.LRUCache(300, 0.66);
        this._seq = 0;
    }
    memorize(model, pos, item) {
    ...
    fromJSON(data) {
        ...
        for (const [key, value] of data) {
            value.touch = seq;
            value.type = typeof value.type === 'number' ? value.type : languages_js_1.CompletionItemKinds.fromString(value.type);
...
class PrefixMemory extends Memory {
    constructor() {
        ...
        this._trie = ternarySearchTree_js_1.TernarySearchTree.forStrings();
        this._seq = 0;
    }
    memorize(model, pos, item) {
...
let SuggestMemoryService = class SuggestMemoryService {
    ...
    constructor(_storageService, _configService) {
        ...
        this._persistSoon = new async_js_1.RunOnceScheduler(() => this._saveState(), 500);
...
exports.ISuggestMemoryService = (0, instantiation_js_1.createDecorator)('ISuggestMemories');
(0, extensions_js_1.registerSingleton)(exports.ISuggestMemoryService, SuggestMemoryService, 1 /* InstantiationType.Delayed */);
