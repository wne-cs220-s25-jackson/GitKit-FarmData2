...
const resizable_js_1 = require("../../../../base/browser/ui/resizable/resizable.js");
...
let SuggestDetailsWidget = class SuggestDetailsWidget {
    constructor(_editor, instaService) {
        ...
        this._onDidClose = new event_js_1.Emitter();
        this.onDidClose = this._onDidClose.event;
        this._onDidChangeContents = new event_js_1.Emitter();
        this.onDidChangeContents = this._onDidChangeContents.event;
        this._disposables = new lifecycle_js_1.DisposableStore();
        this._renderDisposeable = new lifecycle_js_1.DisposableStore();
        this._borderWidth = 1;
        this._size = new dom.Dimension(330, 0);
        this.domNode = dom.$('.suggest-details');
        this.domNode.classList.add('no-docs');
        this._markdownRenderer = instaService.createInstance(markdownRenderer_js_1.MarkdownRenderer, { editor: _editor });
        this._body = dom.$('.body');
        this._scrollbar = new scrollableElement_js_1.DomScrollableElement(this._body, {
            alwaysConsumeMouseWheel: true,
        });
        dom.append(this.domNode, this._scrollbar.getDomNode());
        this._disposables.add(this._scrollbar);
        this._header = dom.append(this._body, dom.$('.header'));
        this._close = dom.append(this._header, dom.$('span' + themables_js_1.ThemeIcon.asCSSSelector(codicons_js_1.Codicon.close)));
    ...
    renderItem(item, explainMode) {
        ...
        if (explainMode) {
            ...
            documentation = new htmlContent_js_1.MarkdownString().appendCodeblock('empty', md);
...
class SuggestDetailsOverlay {
    constructor(widget, _editor) {
        ...
        this._resizable = new resizable_js_1.ResizableHTMLElement();
