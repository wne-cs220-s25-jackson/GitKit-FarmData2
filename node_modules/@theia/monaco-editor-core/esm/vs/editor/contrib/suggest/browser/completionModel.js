...
class CompletionModel {
    constructor(items, column, lineContext, wordDistance, options, snippetSuggestions, fuzzyScoreOptions = filters_js_1.FuzzyScoreOptions.default, clipboardText = undefined) {
    ...
    _createCachedState() {
        ...
        // user-configuration
        const scoreFn = (!this._options.filterGraceful || source.length > 2000) ? filters_js_1.fuzzyScore : filters_js_1.fuzzyScoreGracefulAggressive;
        for (let i = 0; i < source.length; i++) {
            ...
            if (wordLen === 0) {
                ...
                item.score = filters_js_1.FuzzyScore.Default;
            }
            else {
                ...
                if (wordPos >= wordLen) {
                    ...
                    if ((0, strings_js_1.compareIgnoreCase)(item.completion.filterText, item.textLabel) === 0) {
                        ...
                        item.score = (0, filters_js_1.anyScore)(word, wordLow, wordPos, item.textLabel, item.labelLow, 0);
        ...
        this._stats = {
            pLabelLen: labelLengths.length ?
                (0, arrays_js_1.quickSelect)(labelLengths.length - .85, labelLengths, (a, b) => a - b)
                : 0
        };
    }
