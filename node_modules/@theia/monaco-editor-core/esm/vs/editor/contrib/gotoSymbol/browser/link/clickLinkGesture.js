...
class ClickLinkGesture extends lifecycle_js_1.Disposable {
    constructor(editor, opts) {
        super();
        this._onMouseMoveOrRelevantKeyDown = this._register(new event_js_1.Emitter());
        this.onMouseMoveOrRelevantKeyDown = this._onMouseMoveOrRelevantKeyDown.event;
        this._onExecute = this._register(new event_js_1.Emitter());
        this.onExecute = this._onExecute.event;
        this._onCancel = this._register(new event_js_1.Emitter());
