...
const snippetSession_js_1 = require("./snippetSession.js");
...
let SnippetController2 = class SnippetController2 {
    ...
    static { this.InSnippetMode = new contextkey_js_1.RawContextKey('inSnippetMode', false, (0, nls_js_1.localize)('inSnippetMode', "Whether the editor in current in snippet mode")); }
    static { this.HasNextTabstop = new contextkey_js_1.RawContextKey('hasNextTabstop', false, (0, nls_js_1.localize)('hasNextTabstop', "Whether there is a next tab stop when in snippet mode")); }
    static { this.HasPrevTabstop = new contextkey_js_1.RawContextKey('hasPrevTabstop', false, (0, nls_js_1.localize)('hasPrevTabstop', "Whether there is a previous tab stop when in snippet mode")); }
    constructor(_editor, _logService, _languageFeaturesService, contextKeyService, _languageConfigurationService) {
        this._editor = _editor;
        this._logService = _logService;
        this._languageFeaturesService = _languageFeaturesService;
        this._languageConfigurationService = _languageConfigurationService;
        this._snippetListener = new lifecycle_js_1.DisposableStore();
    ...
    _doInsert(template, opts) {
        ...
        if (!this._session) {
            ...
            this._session = new snippetSession_js_1.SnippetSession(this._editor, template, opts, this._languageConfigurationService);
            this._session.insert();
        }
        else {
            (0, types_js_1.assertType)(typeof template === 'string');
        ...
        if (this._session?.hasChoice) {
            const provider = {
                ...
                provideCompletionItems: (model, position) => {
                    if (!this._session || model !== this._editor.getModel() || !position_js_1.Position.equals(this._editor.getPosition(), position)) {
                        return undefined;
                    }
                    ...
                    for (let i = 0; i < activeChoice.choice.options.length; i++) {
                        ...
                        suggestions.push({
                            ...
                            command: { id: 'jumpToNextSnippetPlaceholder', title: (0, nls_js_1.localize)('next', 'Go to next placeholder...') }
                        });
                    }
                    return { suggestions };
                }
    ...
    _handleChoice() {
        ...
        if (this._currentChoice !== activeChoice.choice) {
            ...
            queueMicrotask(() => {
                (0, suggest_js_1.showSimpleSuggestions)(this._editor, this._choiceCompletions.provider);
            });
        }
    }
    finish() {
...
(0, editorExtensions_js_1.registerEditorContribution)(SnippetController2.ID, SnippetController2, 4 /* EditorContributionInstantiation.Lazy */);
const CommandCtor = editorExtensions_js_1.EditorCommand.bindToContribution(SnippetController2.get);
(0, editorExtensions_js_1.registerEditorCommand)(new CommandCtor({
    id: 'jumpToNextSnippetPlaceholder',
    precondition: contextkey_js_1.ContextKeyExpr.and(SnippetController2.InSnippetMode, SnippetController2.HasNextTabstop),
...
(0, editorExtensions_js_1.registerEditorCommand)(new CommandCtor({
    ...
    precondition: contextkey_js_1.ContextKeyExpr.and(SnippetController2.InSnippetMode, SnippetController2.HasPrevTabstop),
