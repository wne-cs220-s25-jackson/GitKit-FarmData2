...
class CodeLensContentWidget {
    ...
    withCommands(lenses, animate) {
        ...
        for (let i = 0; i < lenses.length; i++) {
            ...
            hasSymbol = true;
            if (lens.command) {
                const title = (0, iconLabels_js_1.renderLabelWithIcons)(lens.command.title.trim());
                if (lens.command.id) {
...
const codeLensDecorationOptions = textModel_js_1.ModelDecorationOptions.register({
...
class CodeLensWidget {
    constructor(data, editor, helper, viewZoneChangeAccessor, heightInPx, updateCallback) {
        ...
        this._data.forEach((codeLensData, i) => {
            ...
            if (!range) {
                range = range_js_1.Range.lift(codeLensData.symbol.range);
            }
            else {
                range = range_js_1.Range.plusRange(range, codeLensData.symbol.range);
            }
        });
    ...
    isValid() {
        return this._decorationIds.some((id, i) => {
            ...
            return !!(range && range_js_1.Range.isEmpty(symbol.range) === range.isEmpty());
        });
    }
