...
class CursorUndoRedoController extends lifecycle_js_1.Disposable {
...
class CursorUndo extends editorExtensions_js_1.EditorAction {
    constructor() {
        super({
            id: 'cursorUndo',
...
class CursorRedo extends editorExtensions_js_1.EditorAction {
    constructor() {
        super({
            id: 'cursorRedo',
...
(0, editorExtensions_js_1.registerEditorContribution)(CursorUndoRedoController.ID, CursorUndoRedoController, 0 /* EditorContributionInstantiation.Eager */); // eager because it needs to listen to record cursor state ASAP
(0, editorExtensions_js_1.registerEditorAction)(CursorUndo);
(0, editorExtensions_js_1.registerEditorAction)(CursorRedo);
