...
let UnusualLineTerminatorsDetector = class UnusualLineTerminatorsDetector extends lifecycle_js_1.Disposable {
    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                ...
                detail: nls.localize('unusualLineTerminators.detail', "The file '{0}' contains one or more unusual line terminator characters, like Line Separator (LS) or Paragraph Separator (PS).\n\nIt is recommended to remove them from the file. This can be configured via `editor.unusualLineTerminators`.", (0, resources_js_1.basename)(model.uri)),
...
exports.UnusualLineTerminatorsDetector = UnusualLineTerminatorsDetector = __decorate([
    __param(1, dialogs_js_1.IDialogService),
    __param(2, codeEditorService_js_1.ICodeEditorService)
], UnusualLineTerminatorsDetector);
(0, editorExtensions_js_1.registerEditorContribution)(UnusualLineTerminatorsDetector.ID, UnusualLineTerminatorsDetector, 1 /* EditorContributionInstantiation.AfterFirstRender */);
