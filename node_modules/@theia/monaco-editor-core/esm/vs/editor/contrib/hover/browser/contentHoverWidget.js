...
const resizableContentWidget_js_1 = require("./resizableContentWidget.js");
...
let ContentHoverWidget = class ContentHoverWidget extends resizableContentWidget_js_1.ResizableContentWidget {
    ...
    constructor(editor, contextKeyService, _configurationService, _accessibilityService, _keybindingService) {
        ...
        this._hover = this._register(new hoverWidget_js_1.HoverWidget(true));
        this._onDidResize = this._register(new event_js_1.Emitter());
        this.onDidResize = this._onDidResize.event;
        this._minimumSize = minimumSize;
        this._hoverVisibleKey = editorContextKeys_js_1.EditorContextKeys.hoverVisible.bindTo(contextKeyService);
        this._hoverFocusedKey = editorContextKeys_js_1.EditorContextKeys.hoverFocused.bindTo(contextKeyService);
