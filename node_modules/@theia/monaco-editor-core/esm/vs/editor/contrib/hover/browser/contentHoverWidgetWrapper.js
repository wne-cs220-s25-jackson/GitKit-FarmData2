...
const hoverOperation_js_1 = require("./hoverOperation.js");
...
const contentHoverWidget_js_1 = require("./contentHoverWidget.js");
const contentHoverComputer_js_1 = require("./contentHoverComputer.js");
const contentHoverTypes_js_1 = require("./contentHoverTypes.js");
const event_js_1 = require("../../../../base/common/event.js");
const contentHoverRendered_js_1 = require("./contentHoverRendered.js");
const hoverUtils_js_1 = require("./hoverUtils.js");
const hover_js_1 = require("../../../../platform/hover/browser/hover.js");
let ContentHoverWidgetWrapper = class ContentHoverWidgetWrapper extends lifecycle_js_1.Disposable {
    constructor(_editor, _instantiationService, _keybindingService, _hoverService) {
        ...
        this._onContentsChanged = this._register(new event_js_1.Emitter());
        this.onContentsChanged = this._onContentsChanged.event;
        this._contentHoverWidget = this._register(this._instantiationService.createInstance(contentHoverWidget_js_1.ContentHoverWidget, this._editor));
        this._participants = this._initializeHoverParticipants();
        this._hoverOperation = this._register(new hoverOperation_js_1.HoverOperation(this._editor, new contentHoverComputer_js_1.ContentHoverComputer(this._editor, this._participants)));
        this._registerListeners();
    }
    _initializeHoverParticipants() {
        const participants = [];
        for (const participant of hoverTypes_js_1.HoverParticipantRegistry.getAll()) {
    ...
    _registerListeners() {
        this._register(this._hoverOperation.onResult((result) => {
            ...
            this._withResult(new contentHoverTypes_js_1.ContentHoverResult(messages, result.isComplete, result.options));
        }));
        ...
        this._register(languages_js_1.TokenizationRegistry.onDidChange(() => {
    ...
    _showHover(hoverResult) {
        ...
        this._renderedContentHover = new contentHoverRendered_js_1.RenderedContentHover(this._editor, hoverResult, this._participants, context, this._keybindingService, this._hoverService);
    ...
    _findHoverAnchorCandidates(mouseEvent) {
        ...
        switch (target.type) {
            case 6 /* MouseTargetType.CONTENT_TEXT */: {
                anchorCandidates.push(new hoverTypes_js_1.HoverRangeAnchor(0, target.range, mouseEvent.event.posx, mouseEvent.event.posy));
                break;
            }
    ...
    _onMouseLeave(e) {
        ...
        const isMousePositionOutsideOfEditor = !editorDomNode || !(0, hoverUtils_js_1.isMousePositionWithinElement)(editorDomNode, e.x, e.y);
        if (isMousePositionOutsideOfEditor) {
            this.hide();
        }
    }
    startShowingAtRange(range, mode, source, focus) {
        this._startShowingOrUpdateHover(new hoverTypes_js_1.HoverRangeAnchor(0, range, undefined, undefined), mode, source, focus, null);
    }
    getWidgetContent() {
...
exports.ContentHoverWidgetWrapper = ContentHoverWidgetWrapper = __decorate([
    ...
    __param(3, hover_js_1.IHoverService)
