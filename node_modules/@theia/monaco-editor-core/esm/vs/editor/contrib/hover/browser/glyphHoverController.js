...
exports.GlyphHoverController = void 0;
...
require("./hover.css");
const glyphHoverWidget_js_1 = require("./glyphHoverWidget.js");
// sticky hover widget which doesn't disappear on focus out and such
const _sticky = false;
let GlyphHoverController = class GlyphHoverController extends lifecycle_js_1.Disposable {
    ...
    _isMouseOnGlyphHoverWidget(mouseEvent) {
        ...
        if (glyphHoverWidgetNode) {
            return (0, hoverUtils_js_1.isMousePositionWithinElement)(glyphHoverWidgetNode, mouseEvent.event.posx, mouseEvent.event.posy);
        }
        return false;
    }
    _onEditorMouseUp() {
    ...
    _getOrCreateGlyphWidget() {
        if (!this._glyphWidget) {
            this._glyphWidget = this._instantiationService.createInstance(glyphHoverWidget_js_1.GlyphHoverWidget, this._editor);
        }
...
exports.GlyphHoverController = GlyphHoverController;
exports.GlyphHoverController = GlyphHoverController = GlyphHoverController_1 = __decorate([
