...
const glyphHoverComputer_js_1 = require("./glyphHoverComputer.js");
const hoverUtils_js_1 = require("./hoverUtils.js");
const $ = dom.$;
let GlyphHoverWidget = class GlyphHoverWidget extends lifecycle_js_1.Disposable {
    static { GlyphHoverWidget_1 = this; }
    static { this.ID = 'editor.contrib.modesGlyphHoverWidget'; }
    constructor(editor, languageService, openerService) {
        super();
        this._renderDisposeables = this._register(new lifecycle_js_1.DisposableStore());
        this._editor = editor;
        this._isVisible = false;
        this._messages = [];
        this._hover = this._register(new hoverWidget_js_1.HoverWidget(true));
        this._hover.containerDomNode.classList.toggle('hidden', !this._isVisible);
        this._markdownRenderer = this._register(new markdownRenderer_js_1.MarkdownRenderer({ editor: this._editor }, languageService, openerService));
        this._hoverOperation = this._register(new hoverOperation_js_1.HoverOperation(this._editor, new glyphHoverComputer_js_1.GlyphHoverComputer(this._editor)));
...
exports.GlyphHoverWidget = GlyphHoverWidget = GlyphHoverWidget_1 = __decorate([
