 ...
 */
class HoverOperation extends lifecycle_js_1.Disposable {
    constructor(_editor, _computer) {
        super();
        this._editor = _editor;
        this._computer = _computer;
        this._onResult = this._register(new event_js_1.Emitter());
    ...
    _triggerAsyncComputation(options) {
        ...
        if (this._computer.computeAsync) {
            this._asyncIterableDone = false;
            this._asyncIterable = (0, async_js_1.createCancelableAsyncIterable)(token => this._computer.computeAsync(options, token));
            (async () => {
                try {
...
class Debouncer extends lifecycle_js_1.Disposable {
    constructor(runner, debounceTimeMs) {
        super();
        this._scheduler = this._register(new async_js_1.RunOnceScheduler(() => runner(this._options), debounceTimeMs));
    }
