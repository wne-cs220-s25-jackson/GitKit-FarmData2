...
let SectionHeaderDetector = class SectionHeaderDetector extends lifecycle_js_1.Disposable {
    ...
    constructor(editor, languageConfigurationService, editorWorkerService) {
        ...
        this.computeSectionHeaders = this._register(new async_js_1.RunOnceScheduler(() => {
...
exports.SectionHeaderDetector = SectionHeaderDetector = __decorate([
    ...
    __param(2, editorWorker_js_1.IEditorWorkerService)
...
(0, editorExtensions_js_1.registerEditorContribution)(SectionHeaderDetector.ID, SectionHeaderDetector, 1 /* EditorContributionInstantiation.AfterFirstRender */);
