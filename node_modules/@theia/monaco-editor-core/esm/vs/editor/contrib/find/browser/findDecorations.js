...
class FindDecorations {
            ...
            this._editor.changeDecorations((changeAccessor) => {
                ...
                if (newCurrentDecorationId !== null) {
                    ...
                    if (rng.startLineNumber !== rng.endLineNumber && rng.endColumn === 1) {
                        ...
                        rng = new range_js_1.Range(rng.startLineNumber, rng.startColumn, lineBeforeEnd, lineBeforeEndMaxColumn);
                    }
                ...
                for (let i = 1, len = findMatches.length; i < len; i++) {
                    ...
                    if (prevEndLineNumber + mergeLinesDelta >= range.startLineNumber) {
                        ...
                        newOverviewRulerApproximateDecorations.push({
                            range: new range_js_1.Range(prevStartLineNumber, 1, prevEndLineNumber, 1),
    ...
    static { this._CURRENT_FIND_MATCH_DECORATION = textModel_js_1.ModelDecorationOptions.register({
        ...
        overviewRuler: {
            color: (0, themeService_js_1.themeColorFromId)(colorRegistry_js_1.overviewRulerFindMatchForeground),
            position: model_js_1.OverviewRulerLane.Center
        },
        minimap: {
            color: (0, themeService_js_1.themeColorFromId)(colorRegistry_js_1.minimapFindMatch),
            position: 1 /* MinimapPosition.Inline */
        }
    }); }
    static { this._FIND_MATCH_DECORATION = textModel_js_1.ModelDecorationOptions.register({
    ...
    static { this._FIND_MATCH_NO_OVERVIEW_DECORATION = textModel_js_1.ModelDecorationOptions.register({
        description: 'find-match-no-overview',
        stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
        className: 'findMatch',
        showIfCollapsed: true
    }); }
    static { this._FIND_MATCH_ONLY_OVERVIEW_DECORATION = textModel_js_1.ModelDecorationOptions.register({
    ...
    static { this._RANGE_HIGHLIGHT_DECORATION = textModel_js_1.ModelDecorationOptions.register({
        description: 'find-range-highlight',
        stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */,
        className: 'rangeHighlight',
        isWholeLine: true
    }); }
    static { this._FIND_SCOPE_DECORATION = textModel_js_1.ModelDecorationOptions.register({
