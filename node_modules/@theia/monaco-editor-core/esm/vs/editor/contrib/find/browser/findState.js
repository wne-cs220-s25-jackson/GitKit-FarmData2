...
class FindReplaceState extends lifecycle_js_1.Disposable {
    ...
    constructor() {
        super();
        this._onFindReplaceStateChange = this._register(new event_js_1.Emitter());
    ...
    changeMatchInfo(matchesPosition, matchesCount, currentMatch) {
        ...
        if (typeof currentMatch !== 'undefined') {
            if (!range_js_1.Range.equalsRange(this._currentMatch, currentMatch)) {
        ...
        if (typeof newState.searchScope !== 'undefined') {
            if (!newState.searchScope?.every((newSearchScope) => {
                return this._searchScope?.some(existingSearchScope => {
                    return !range_js_1.Range.equalsRange(existingSearchScope, newSearchScope);
                });
            })) {
    ...
    canNavigateInLoop() {
        return this._loop || (this.matchesCount >= findModel_js_1.MATCHES_LIMIT);
    }
}
