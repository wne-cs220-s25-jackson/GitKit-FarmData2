...
const wordOperations_js_1 = require("../../wordOperations/browser/wordOperations.js");
const commands_js_1 = require("../../../../platform/commands/common/commands.js");
class DeleteWordPartLeft extends wordOperations_js_1.DeleteWordCommand {
    constructor() {
        super({
    ...
    _delete(ctx, wordNavigationType) {
        const r = cursorWordOperations_js_1.WordPartOperations.deleteWordPartLeft(ctx);
        if (r) {
            return r;
        }
...
class DeleteWordPartRight extends wordOperations_js_1.DeleteWordCommand {
    constructor() {
        super({
            whitespaceHeuristics: true,
    ...
    _delete(ctx, wordNavigationType) {
        const r = cursorWordOperations_js_1.WordPartOperations.deleteWordPartRight(ctx);
        if (r) {
            return r;
        }
...
class WordPartLeftCommand extends wordOperations_js_1.MoveWordCommand {
    _move(wordSeparators, model, position, wordNavigationType, hasMulticursor) {
        return cursorWordOperations_js_1.WordPartOperations.moveWordPartLeft(wordSeparators, model, position, hasMulticursor);
    }
}
...
class WordPartRightCommand extends wordOperations_js_1.MoveWordCommand {
    _move(wordSeparators, model, position, wordNavigationType, hasMulticursor) {
...
(0, editorExtensions_js_1.registerEditorCommand)(new DeleteWordPartLeft());
(0, editorExtensions_js_1.registerEditorCommand)(new DeleteWordPartRight());
(0, editorExtensions_js_1.registerEditorCommand)(new CursorWordPartLeft());
(0, editorExtensions_js_1.registerEditorCommand)(new CursorWordPartLeftSelect());
(0, editorExtensions_js_1.registerEditorCommand)(new CursorWordPartRight());
(0, editorExtensions_js_1.registerEditorCommand)(new CursorWordPartRightSelect());
