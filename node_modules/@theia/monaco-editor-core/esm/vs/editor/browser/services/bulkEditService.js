...
exports.IBulkEditService = (0, instantiation_js_1.createDecorator)('IWorkspaceEditService');
class ResourceEdit {
...
class ResourceTextEdit extends ResourceEdit {
    static is(candidate) {
        ...
        return (0, types_js_1.isObject)(candidate)
            && uri_js_1.URI.isUri(candidate.resource)
            && (0, types_js_1.isObject)(candidate.textEdit);
    }
    static lift(edit) {
