...
class EditorMouseEvent extends mouseEvent_js_1.StandardMouseEvent {
...
class GlobalEditorPointerMoveMonitor extends lifecycle_js_1.Disposable {
    constructor(editorViewDomNode) {
        super();
        this._editorViewDomNode = editorViewDomNode;
        this._globalPointerMoveMonitor = this._register(new globalPointerMoveMonitor_js_1.GlobalPointerMoveMonitor());
...
class DynamicCssRules {
    ...
    constructor(_editor) {
        ...
        this._garbageCollectionScheduler = new async_js_1.RunOnceScheduler(() => this.garbageCollect(), 1000);
    }
...
class RefCountedCssRule {
    constructor(key, className, _containerElement, properties) {
        ...
        this._styleElementDisposables = new lifecycle_js_1.DisposableStore();
    ...
    getCssText(className, properties) {
        ...
        for (const prop in properties) {
            ...
            if (typeof value === 'object') {
                cssValue = (0, colorRegistry_js_1.asCssVariable)(value.id);
            }
            else {
                cssValue = value;
            }
