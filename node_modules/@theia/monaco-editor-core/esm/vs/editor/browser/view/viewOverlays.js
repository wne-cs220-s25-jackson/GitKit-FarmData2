...
const viewLayer_js_1 = require("./viewLayer.js");
const viewPart_js_1 = require("./viewPart.js");
class ViewOverlays extends viewPart_js_1.ViewPart {
    constructor(context) {
        super(context);
...
class ViewOverlayLine {
    ...
    setDomNode(domNode) {
        this._domNode = (0, fastDomNode_js_1.createFastDomNode)(domNode);
    }
    onContentChanged() {
        // Nothing
    }
...
class MarginViewOverlays extends ViewOverlays {
    constructor(context) {
        ...
        (0, domFontInfo_js_1.applyFontInfo)(this.domNode, options.get(52 /* EditorOption.fontInfo */));
    }
    onConfigurationChanged(e) {
        const options = this._context.configuration.options;
        (0, domFontInfo_js_1.applyFontInfo)(this.domNode, options.get(52 /* EditorOption.fontInfo */));
