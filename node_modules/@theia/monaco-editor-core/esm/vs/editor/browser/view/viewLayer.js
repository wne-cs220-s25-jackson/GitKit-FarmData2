...
class VisibleLinesCollection {
    ...
    _createDomNode() {
        const domNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
...
class ViewLayerRenderer {
    static { this._ttPolicy = (0, trustedTypes_js_1.createTrustedTypesPolicy)('editorViewLayer', { createHTML: value => value }); }
    ...
    static { this._sb = new stringBuilder_js_1.StringBuilder(100000); }
