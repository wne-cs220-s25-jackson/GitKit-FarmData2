...
const domFontInfo_js_1 = require("./domFontInfo.js");
...
class DomCharWidthReader {
    ...
    _createDomElements() {
        ...
        (0, domFontInfo_js_1.applyFontInfo)(regularDomNode, this._bareFontInfo);
        container.appendChild(regularDomNode);
        const boldDomNode = document.createElement('div');
        (0, domFontInfo_js_1.applyFontInfo)(boldDomNode, this._bareFontInfo);
        boldDomNode.style.fontWeight = 'bold';
        container.appendChild(boldDomNode);
        const italicDomNode = document.createElement('div');
        (0, domFontInfo_js_1.applyFontInfo)(italicDomNode, this._bareFontInfo);
