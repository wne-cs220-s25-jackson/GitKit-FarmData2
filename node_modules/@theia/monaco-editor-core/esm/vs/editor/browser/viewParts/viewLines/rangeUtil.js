...
class RangeUtil {
    ...
    static _mergeAdjacentRanges(ranges) {
        ...
        ranges.sort(renderingContext_js_1.FloatHorizontalRange.compare);
        const result = [];
        let resultLen = 0;
        let prev = ranges[0];
    ...
    static _createHorizontalRangesFromClientRects(clientRects, clientRectDeltaLeft, clientRectScale) {
        ...
        for (let i = 0, len = clientRects.length; i < len; i++) {
            ...
            result[i] = new renderingContext_js_1.FloatHorizontalRange(Math.max(0, (clientRect.left - clientRectDeltaLeft) / clientRectScale), clientRect.width / clientRectScale);
        }
