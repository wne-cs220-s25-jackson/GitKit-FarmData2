...
const globalPointerMoveMonitor_js_1 = require("../../../../base/browser/globalPointerMoveMonitor.js");
const lifecycle_js_1 = require("../../../../base/common/lifecycle.js");
const platform = require("../../../../base/common/platform.js");
const strings = require("../../../../base/common/strings.js");
const viewLayer_js_1 = require("../../view/viewLayer.js");
...
const rgba_js_1 = require("../../../common/core/rgba.js");
const minimapTokensColorTracker_js_1 = require("../../../common/viewModel/minimapTokensColorTracker.js");
...
const minimapCharRendererFactory_js_1 = require("./minimapCharRendererFactory.js");
const functional_js_1 = require("../../../../base/common/functional.js");
const map_js_1 = require("../../../../base/common/map.js");
const fonts_js_1 = require("../../../../base/browser/fonts.js");
/**
...
class MinimapOptions {
    constructor(configuration, theme, tokensColorTracker) {
        ...
        this.sectionHeaderFontFamily = fonts_js_1.DEFAULT_FONT_FAMILY;
        ...
        this.charRenderer = (0, functional_js_1.createSingleCallFunction)(() => minimapCharRendererFactory_js_1.MinimapCharRendererFactory.create(this.fontScale, fontInfo.fontFamily));
    ...
    static _getMinimapBackground(theme, defaultBackgroundColor) {
        const themeColor = theme.getColor(colorRegistry_js_1.minimapBackground);
        if (themeColor) {
            return new rgba_js_1.RGBA8(themeColor.rgba.r, themeColor.rgba.g, themeColor.rgba.b, Math.round(255 * themeColor.rgba.a));
        }
        return defaultBackgroundColor;
    }
    static _getMinimapForegroundOpacity(theme) {
        const themeColor = theme.getColor(colorRegistry_js_1.minimapForegroundOpacity);
        if (themeColor) {
            return rgba_js_1.RGBA8._clamp(Math.round(255 * themeColor.rgba.a));
        }
        return 255;
    }
    static _getSectionHeaderColor(theme, defaultForegroundColor) {
        const themeColor = theme.getColor(colorRegistry_js_1.editorForeground);
        if (themeColor) {
            return new rgba_js_1.RGBA8(themeColor.rgba.r, themeColor.rgba.g, themeColor.rgba.b, Math.round(255 * themeColor.rgba.a));
        }
...
class RenderData {
    constructor(renderedLayout, imageData, lines) {
        ...
        this._renderedLines = new viewLayer_js_1.RenderedLinesCollection({
...
class MinimapSamplingState {
    static compute(options, viewLineCount, oldSamplingState) {
        ...
        const { minimapLineCount } = editorOptions_js_1.EditorLayoutInfoComputer.computeContainedMinimapLineCount({
 ...
 * view of the file.
 */
class Minimap extends viewPart_js_1.ViewPart {
    constructor(context) {
        super(context);
        this._sectionHeaderCache = new map_js_1.LRUCache(10, 1.5);
        this.tokensColorTracker = minimapTokensColorTracker_js_1.MinimapTokensColorTracker.getInstance();
        this._selections = [];
        ...
        if (this._minimapSelections === null) {
            if (this._samplingState) {
                ...
                for (const selection of this._selections) {
                    ...
                    this._minimapSelections.push(new selection_js_1.Selection(minimapLineStart, selection.startColumn, minimapLineEnd, selection.endColumn));
                }
            }
            else {
    ...
    getMinimapDecorationsInViewport(startLineNumber, endLineNumber) {
        ...
        if (this._samplingState) {
            ...
            for (const decoration of decorations) {
                ...
                result.push(new viewModel_js_1.ViewModelDecoration(new range_js_1.Range(minimapStartLineNumber, range.startColumn, minimapEndLineNumber, range.endColumn), decoration.options));
            }
            return result;
        }
        return decorations;
    ...
    _getMinimapDecorationsInViewport(startLineNumber, endLineNumber) {
        ...
        if (this._samplingState) {
            ...
            visibleRange = new range_js_1.Range(modelStartLineNumber, 1, modelEndLineNumber, this._context.viewModel.getLineMaxColumn(modelEndLineNumber));
        }
        else {
            visibleRange = new range_js_1.Range(startLineNumber, 1, endLineNumber, this._context.viewModel.getLineMaxColumn(endLineNumber));
        }
    ...
    revealLineNumber(lineNumber) {
        ...
        this._context.viewModel.revealRange('mouse', false, new range_js_1.Range(lineNumber, 1, lineNumber, 1), 1 /* viewEvents.VerticalRevealType.Center */, 0 /* ScrollType.Smooth */);
    }
...
class InnerMinimap extends lifecycle_js_1.Disposable {
    constructor(theme, model) {
        ...
        this._buffers = null;
        this._selectionColor = this._theme.getColor(colorRegistry_js_1.minimapSelection);
        this._domNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        viewPart_js_1.PartFingerprints.write(this._domNode, 9 /* PartFingerprint.Minimap */);
        this._domNode.setClassName(this._getMinimapDomNodeClassName());
        this._domNode.setPosition('absolute');
        this._domNode.setAttribute('role', 'presentation');
        this._domNode.setAttribute('aria-hidden', 'true');
        this._shadow = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        this._shadow.setClassName('minimap-shadow-hidden');
        this._domNode.appendChild(this._shadow);
        this._canvas = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('canvas'));
        this._canvas.setPosition('absolute');
        this._canvas.setLeft(0);
        this._domNode.appendChild(this._canvas);
        this._decorationsCanvas = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('canvas'));
        this._decorationsCanvas.setPosition('absolute');
        this._decorationsCanvas.setClassName('minimap-decorations-layer');
        this._decorationsCanvas.setLeft(0);
        this._domNode.appendChild(this._decorationsCanvas);
        this._slider = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        this._slider.setPosition('absolute');
        this._slider.setClassName('minimap-slider');
        this._slider.setLayerHinting(true);
        this._slider.setContain('strict');
        this._domNode.appendChild(this._slider);
        this._sliderHorizontal = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        ...
        this._sliderPointerMoveMonitor = new globalPointerMoveMonitor_js_1.GlobalPointerMoveMonitor();
        ...
        this._gestureDisposable = touch_js_1.Gesture.addTarget(this._domNode.domNode);
        this._sliderTouchStartListener = dom.addDisposableListener(this._domNode.domNode, touch_js_1.EventType.Start, (e) => {
            e.preventDefault();
            e.stopPropagation();
            if (this._lastRenderData) {
        ...
        this._sliderTouchMoveListener = dom.addDisposableListener(this._domNode.domNode, touch_js_1.EventType.Change, (e) => {
            e.preventDefault();
            e.stopPropagation();
        ...
        this._sliderTouchEndListener = dom.addStandardDisposableListener(this._domNode.domNode, touch_js_1.EventType.End, (e) => {
            e.preventDefault();
            e.stopPropagation();
            this._gestureInProgress = false;
    ...
    _renderSelectionLineHighlights(canvasContext, selections, highlightedLines, layout, minimapLineHeight) {
        ...
        for (const selection of selections) {
            ...
            if (y2 >= yy1) {
                ...
                if (y2 > y1) {
                    // flush
                    canvasContext.fillRect(editorOptions_js_1.MINIMAP_GUTTER_WIDTH, y1, canvasContext.canvas.width, y2 - y1);
                }
                y1 = yy1;
                y2 = yy2;
            }
    ...
    _renderDecorationsLineHighlights(canvasContext, decorations, highlightedLines, layout, minimapLineHeight) {
        ...
        for (let i = decorations.length - 1; i >= 0; i--) {
            ...
            for (let line = startLineNumber; line <= endLineNumber; line++) {
                ...
                canvasContext.fillRect(editorOptions_js_1.MINIMAP_GUTTER_WIDTH, y, canvasContext.canvas.width, minimapLineHeight);
            }
        }
    }
    ...
    getXOffsetForPosition(lineOffsetMap, lineNumber, column, tabSize, charWidth, canvasInnerWidth) {
        if (column === 1) {
            return editorOptions_js_1.MINIMAP_GUTTER_WIDTH;
        }
        ...
        if (!lineIndexToXOffset) {
            ...
            lineIndexToXOffset = [editorOptions_js_1.MINIMAP_GUTTER_WIDTH];
            let prevx = editorOptions_js_1.MINIMAP_GUTTER_WIDTH;
    ...
    _renderSectionHeaders(layout) {
        ...
        const fitWidth = InnerMinimap._fitSectionHeader.bind(null, canvasContext, canvasInnerWidth - editorOptions_js_1.MINIMAP_GUTTER_WIDTH);
        for (const decoration of decorations) {
    ...
    static _renderSectionLabel(target, headerText, hasSeparatorLine, backgroundFill, foregroundFill, minimapWidth, backgroundFillY, backgroundFillHeight, textY, separatorY) {
        if (headerText) {
            ...
            target.fillText(headerText, editorOptions_js_1.MINIMAP_GUTTER_WIDTH, textY);
        }
        if (hasSeparatorLine) {
            target.beginPath();
    ...
    renderLines(layout) {
        ...
        const renderBackground = new rgba_js_1.RGBA8(Math.round((background.r - defaultBackground.r) * backgroundA + defaultBackground.r), Math.round((background.g - defaultBackground.g) * backgroundA + defaultBackground.g), Math.round((background.b - defaultBackground.b) * backgroundA + defaultBackground.b), 255);
    ...
    static _renderLine(target, backgroundColor, backgroundAlpha, useLighterFont, renderMinimap, charWidth, colorTracker, foregroundAlpha, minimapCharRenderer, dy, innerLinePadding, tabSize, lineData, fontScale, minimapLineHeight) {
        ...
        let dx = editorOptions_js_1.MINIMAP_GUTTER_WIDTH;
        let charIndex = 0;
        let tabsCharDelta = 0;
