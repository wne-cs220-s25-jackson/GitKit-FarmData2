...
const minimapCharRenderer_js_1 = require("./minimapCharRenderer.js");
const minimapCharSheet_js_1 = require("./minimapCharSheet.js");
const minimapPreBaked_js_1 = require("./minimapPreBaked.js");
const uint_js_1 = require("../../../../base/common/uint.js");
/**
...
class MinimapCharRendererFactory {
    ...
    static create(scale, fontFamily) {
        ...
        let factory;
        if (minimapPreBaked_js_1.prebakedMiniMaps[scale]) {
            factory = new minimapCharRenderer_js_1.MinimapCharRenderer(minimapPreBaked_js_1.prebakedMiniMaps[scale](), scale);
        }
        else {
    ...
    static createSampleData(fontFamily) {
        ...
        let x = 0;
        for (const code of minimapCharSheet_js_1.allCharCodes) {
    ...
    static createFromSampleData(source, scale) {
        ...
        return new minimapCharRenderer_js_1.MinimapCharRenderer(charData, scale);
    }
    static _downsampleChar(source, sourceOffset, dest, destOffset, scale) {
        ...
        for (let y = 0; y < height; y++) {
            ...
            for (let x = 0; x < width; x++) {
                ...
                dest[targetIndex++] = (0, uint_js_1.toUint8)(final);
            }
        }
        return brightest;
    }
