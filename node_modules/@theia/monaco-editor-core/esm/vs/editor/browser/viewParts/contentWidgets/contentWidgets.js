 ...
 */
class ViewContentWidgets extends viewPart_js_1.ViewPart {
    constructor(context, viewDomNode) {
        super(context);
        this._viewDomNode = viewDomNode;
        this._widgets = {};
        this.domNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        viewPart_js_1.PartFingerprints.write(this.domNode, 1 /* PartFingerprint.ContentWidgets */);
        this.domNode.setClassName('contentWidgets');
        this.domNode.setPosition('absolute');
        this.domNode.setTop(0);
        this.overflowingContentWidgetsDomNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        viewPart_js_1.PartFingerprints.write(this.overflowingContentWidgetsDomNode, 2 /* PartFingerprint.OverflowingContentWidgets */);
...
class Widget {
    constructor(context, viewDomNode, actual) {
        ...
        this._viewDomNode = viewDomNode;
        this._actual = actual;
        this.domNode = (0, fastDomNode_js_1.createFastDomNode)(this._actual.getDomNode());
