 ...
 */
class ViewOverlayWidgets extends viewPart_js_1.ViewPart {
    constructor(context, viewDomNode) {
        ...
        viewPart_js_1.PartFingerprints.write(this._domNode, 4 /* PartFingerprint.OverlayWidgets */);
        this._domNode.setClassName('overlayWidgets');
        this.overflowingOverlayWidgetsDomNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        viewPart_js_1.PartFingerprints.write(this.overflowingOverlayWidgetsDomNode, 5 /* PartFingerprint.OverflowingOverlayWidgets */);
