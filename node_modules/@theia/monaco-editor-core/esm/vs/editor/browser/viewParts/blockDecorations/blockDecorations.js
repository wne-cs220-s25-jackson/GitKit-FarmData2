...
require("./blockDecorations.css");
const viewPart_js_1 = require("../../view/viewPart.js");
class BlockDecorations extends viewPart_js_1.ViewPart {
    constructor(context) {
        super(context);
        this.blocks = [];
        this.contentWidth = -1;
    ...
    render(ctx) {
        ...
        for (const decoration of decorations) {
            ...
            if (!block) {
                block = this.blocks[count] = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
