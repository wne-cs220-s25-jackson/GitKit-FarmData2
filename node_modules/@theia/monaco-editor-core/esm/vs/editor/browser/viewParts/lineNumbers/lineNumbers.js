 ...
 */
class LineNumbersOverlay extends dynamicViewOverlay_js_1.DynamicViewOverlay {
    static { this.CLASS_NAME = 'line-numbers'; }
    constructor(context) {
        super();
        this._context = context;
        this._readConfig();
        this._lastCursorModelPosition = new position_js_1.Position(1, 1);
    ...
    _getLineRenderLineNumber(viewLineNumber) {
        const modelPosition = this._context.viewModel.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(viewLineNumber, 1));
    ...
    prepareRender(ctx) {
        ...
        lineNoDecorations.sort((a, b) => range_js_1.Range.compareRangesUsingEnds(a.range, b.range));
...
(0, themeService_js_1.registerThemingParticipant)((theme, collector) => {
    const editorLineNumbersColor = theme.getColor(editorColorRegistry_js_1.editorLineNumbers);
    const editorDimmedLineNumberColor = theme.getColor(editorColorRegistry_js_1.editorDimmedLineNumber);
