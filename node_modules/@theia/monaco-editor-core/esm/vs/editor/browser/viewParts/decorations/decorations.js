...
class DecorationsOverlay extends dynamicViewOverlay_js_1.DynamicViewOverlay {
    constructor(context) {
        super();
    ...
    _renderNormalDecorations(ctx, decorations, output) {
        ...
        for (let i = 0, lenI = decorations.length; i < lenI; i++) {
            ...
            if (showIfCollapsed && range.endColumn === 1 && range.endLineNumber !== range.startLineNumber) {
                range = new range_js_1.Range(range.startLineNumber, range.startColumn, range.endLineNumber - 1, this._context.viewModel.getLineMaxColumn(range.endLineNumber - 1));
            }
            if (prevClassName === className && prevShowIfCollapsed === showIfCollapsed && range_js_1.Range.areIntersectingOrTouching(prevRange, range)) {
                // merge into previous decoration
                prevRange = range_js_1.Range.plusRange(prevRange, range);
                continue;
            }
        ...
        for (let j = 0, lenJ = linesVisibleRanges.length; j < lenJ; j++) {
            ...
            if (showIfCollapsed && lineVisibleRanges.ranges.length === 1) {
                ...
                if (singleVisibleRange.width < this._typicalHalfwidthCharacterWidth) {
                    ...
                    lineVisibleRanges.ranges[0] = new renderingContext_js_1.HorizontalRange(left, this._typicalHalfwidthCharacterWidth);
                }
            }
