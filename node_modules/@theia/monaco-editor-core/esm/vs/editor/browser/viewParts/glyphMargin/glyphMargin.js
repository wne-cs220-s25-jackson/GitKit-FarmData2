...
class DedupOverlay extends dynamicViewOverlay_js_1.DynamicViewOverlay {
    /**
...
class GlyphMarginWidgets extends viewPart_js_1.ViewPart {
    constructor(context) {
        super(context);
        this._widgets = {};
    ...
    addWidget(widget) {
        const domNode = (0, fastDomNode_js_1.createFastDomNode)(widget.getDomNode());
    ...
    setWidgetPosition(widget, preference) {
        ...
        if (myWidget.preference.lane === preference.lane
            ...
            && range_js_1.Range.equalsRange(myWidget.preference.range, preference.range)) {
            return false;
        }
    ...
    _collectDecorationBasedGlyphRenderRequest(ctx, requests) {
        ...
        for (const d of decorations) {
            ...
            for (let lineNumber = startLineNumber; lineNumber <= endLineNumber; lineNumber++) {
                const modelPosition = this._context.viewModel.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(lineNumber, 0));
    ...
    _collectWidgetBasedGlyphRenderRequest(ctx, requests) {
        ...
        for (const widget of Object.values(this._widgets)) {
            ...
            const { startLineNumber, endLineNumber } = this._context.viewModel.coordinatesConverter.convertModelRangeToViewRange(range_js_1.Range.lift(range));
            ...
            const modelPosition = this._context.viewModel.coordinatesConverter.convertViewPositionToModelPosition(new position_js_1.Position(widgetLineNumber, 0));
    ...
    prepareRender(ctx) {
        ...
        const requests = new arrays_js_1.ArrayQueue(this._collectSortedGlyphRenderRequests(ctx));
    ...
    render(ctx) {
        ...
        for (let i = 0; i < this._decorationGlyphsToRender.length; i++) {
            ...
            if (i < this._managedDomNodes.length) {
                ...
                domNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
