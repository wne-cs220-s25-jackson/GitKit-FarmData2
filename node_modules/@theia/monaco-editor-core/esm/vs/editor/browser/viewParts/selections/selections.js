 ...
 */
class SelectionsOverlay extends dynamicViewOverlay_js_1.DynamicViewOverlay {
...
(0, themeService_js_1.registerThemingParticipant)((theme, collector) => {
    const editorSelectionForegroundColor = theme.getColor(colorRegistry_js_1.editorSelectionForeground);
