...
const viewCursor_js_1 = require("./viewCursor.js");
 ...
 */
class ViewCursors extends viewPart_js_1.ViewPart {
    ...
    constructor(context) {
        ...
        this._experimentalEditContextEnabled = options.get(37 /* EditorOption.experimentalEditContextEnabled */);
        this._selectionIsEmpty = true;
        this._isComposingInput = false;
        this._isVisible = false;
        this._primaryCursor = new viewCursor_js_1.ViewCursor(this._context, viewCursor_js_1.CursorPlurality.Single);
        ...
        this._startCursorBlinkAnimation = new async_js_1.TimeoutTimer();
        this._cursorFlatBlinkInterval = new dom_js_1.WindowIntervalTimer();
    ...
    _onCursorPositionChanged(position, secondaryPositions, reason) {
        ...
        this._primaryCursor.setPlurality(secondaryPositions.length ? viewCursor_js_1.CursorPlurality.MultiPrimary : viewCursor_js_1.CursorPlurality.Single);
        ...
        if (this._secondaryCursors.length < secondaryPositions.length) {
            ...
            for (let i = 0; i < addCnt; i++) {
                const newCursor = new viewCursor_js_1.ViewCursor(this._context, viewCursor_js_1.CursorPlurality.MultiSecondary);
    ...
    _updateBlinking() {
        ...
        if (!isHidden && !isSolid) {
            if (blinkingStyle === 1 /* TextEditorCursorBlinkingStyle.Blink */) {
                ...
                }, ViewCursors.BLINK_INTERVAL, (0, dom_js_1.getWindow)(this._domNode.domNode));
            }
            else {
    ...
    _getClassName() {
        ...
        switch (this._cursorStyle) {
            case editorOptions_js_1.TextEditorCursorStyle.Line:
                result += ' cursor-line-style';
                break;
            case editorOptions_js_1.TextEditorCursorStyle.Block:
                result += ' cursor-block-style';
                break;
            case editorOptions_js_1.TextEditorCursorStyle.Underline:
                result += ' cursor-underline-style';
                break;
            case editorOptions_js_1.TextEditorCursorStyle.LineThin:
                result += ' cursor-line-thin-style';
                break;
            case editorOptions_js_1.TextEditorCursorStyle.BlockOutline:
                result += ' cursor-block-outline-style';
                break;
            case editorOptions_js_1.TextEditorCursorStyle.UnderlineThin:
...
(0, themeService_js_1.registerThemingParticipant)((theme, collector) => {
    const cursorThemes = [
        { class: '.cursor', foreground: editorColorRegistry_js_1.editorCursorForeground, background: editorColorRegistry_js_1.editorCursorBackground },
        { class: '.cursor-primary', foreground: editorColorRegistry_js_1.editorMultiCursorPrimaryForeground, background: editorColorRegistry_js_1.editorMultiCursorPrimaryBackground },
        { class: '.cursor-secondary', foreground: editorColorRegistry_js_1.editorMultiCursorSecondaryForeground, background: editorColorRegistry_js_1.editorMultiCursorSecondaryBackground },
    ];
    for (const cursorTheme of cursorThemes) {
        ...
        if (caret) {
            ...
            if ((0, theme_js_1.isHighContrast)(theme.type)) {
