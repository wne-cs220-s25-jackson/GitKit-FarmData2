 ...
 * the minimap.
 */
class EditorScrollbar extends viewPart_js_1.ViewPart {
    constructor(context, linesContent, viewDomNode, overflowGuardDomNode) {
        ...
        const scrollbarOptions = {
            ...
            className: 'editor-scrollable' + ' ' + (0, themeService_js_1.getThemeTypeSelector)(context.theme.type),
            useShadows: false,
            lazyRender: true,
        ...
        this.scrollbar = this._register(new scrollableElement_js_1.SmoothScrollableElement(linesContent.domNode, scrollbarOptions, this._context.viewLayout.getScrollable()));
        viewPart_js_1.PartFingerprints.write(this.scrollbar.getDomNode(), 6 /* PartFingerprint.ScrollableElement */);
        this.scrollbarDomNode = (0, fastDomNode_js_1.createFastDomNode)(this.scrollbar.getDomNode());
    ...
    onThemeChanged(e) {
        this.scrollbar.updateClassName('editor-scrollable' + ' ' + (0, themeService_js_1.getThemeTypeSelector)(this._context.theme.type));
        return true;
    }
    // --- end event handlers
    prepareRender(ctx) {
