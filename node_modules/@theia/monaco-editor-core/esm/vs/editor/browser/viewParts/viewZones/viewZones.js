 ...
 */
class ViewZones extends viewPart_js_1.ViewPart {
    constructor(context) {
        super(context);
        ...
        this.marginDomNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
    ...
    _computeWhitespaceProps(zone) {
        ...
        if (typeof zone.afterColumn !== 'undefined') {
            ...
            zoneAfterModelPosition = new position_js_1.Position(validAfterLineNumber, this._context.viewModel.model.getLineMaxColumn(validAfterLineNumber));
        }
    ...
    _addZone(whitespaceAccessor, zone) {
        ...
        const myZone = {
            ...
            isVisible: false,
            domNode: (0, fastDomNode_js_1.createFastDomNode)(zone.domNode),
            marginDomNode: zone.marginDomNode ? (0, fastDomNode_js_1.createFastDomNode)(zone.marginDomNode) : null
        };
