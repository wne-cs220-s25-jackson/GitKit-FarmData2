...
class Settings {
    constructor(config, theme) {
        ...
        const borderColor = theme.getColor(editorColorRegistry_js_1.editorOverviewRulerBorder);
        this.borderColor = borderColor ? borderColor.toString() : null;
        this.hideCursor = options.get(61 /* EditorOption.hideCursorInOverviewRuler */);
        const cursorColorSingle = theme.getColor(editorColorRegistry_js_1.editorCursorForeground);
        this.cursorColorSingle = cursorColorSingle ? cursorColorSingle.transparent(0.7).toString() : null;
        const cursorColorPrimary = theme.getColor(editorColorRegistry_js_1.editorMultiCursorPrimaryForeground);
        this.cursorColorPrimary = cursorColorPrimary ? cursorColorPrimary.transparent(0.7).toString() : null;
        const cursorColorSecondary = theme.getColor(editorColorRegistry_js_1.editorMultiCursorSecondaryForeground);
        ...
        const themeColor = theme.getColor(editorColorRegistry_js_1.editorOverviewRulerBackground);
        const defaultBackground = languages_js_1.TokenizationRegistry.getDefaultBackground();
        if (themeColor) {
    ...
    equals(other) {
        return (this.lineHeight === other.lineHeight
            ...
            && color_js_1.Color.equals(this.backgroundColor, other.backgroundColor)
            && this.top === other.top
...
class DecorationsOverviewRuler extends viewPart_js_1.ViewPart {
    constructor(context) {
        super(context);
        this._actualShouldRender = 0 /* ShouldRenderValue.NotNeeded */;
        this._renderedDecorations = [];
        this._renderedCursorPositions = [];
        this._domNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('canvas'));
        ...
        this._tokensColorTrackerListener = languages_js_1.TokenizationRegistry.onDidChange((e) => {
            if (e.changedColorMap) {
                this._updateSettings(true);
            }
        });
        this._cursorPositions = [{ position: new position_js_1.Position(1, 1), color: this._settings.cursorColorSingle }];
    }
    dispose() {
        super.dispose();
    ...
    onCursorStateChanged(e) {
        ...
        this._cursorPositions.sort((a, b) => position_js_1.Position.compare(a.position, b.position));
    ...
    _render() {
        ...
        if (this._settings.overviewRulerLanes === 0) {
            // overview ruler is off
            this._domNode.setBackgroundColor(backgroundColor ? color_js_1.Color.Format.CSS.formatHexA(backgroundColor) : '');
            this._domNode.setDisplay('none');
            return;
        }
        const decorations = this._context.viewModel.getAllOverviewRulerDecorations(this._context.theme);
        decorations.sort(viewModel_js_1.OverviewRulerDecorationsGroup.compareByRenderingProps);
        if (this._actualShouldRender === 1 /* ShouldRenderValue.Maybe */ && !viewModel_js_1.OverviewRulerDecorationsGroup.equalsArr(this._renderedDecorations, decorations)) {
            this._actualShouldRender = 2 /* ShouldRenderValue.Needed */;
        }
        if (this._actualShouldRender === 1 /* ShouldRenderValue.Maybe */ && !(0, arrays_js_1.equals)(this._renderedCursorPositions, this._cursorPositions, (a, b) => a.position.lineNumber === b.position.lineNumber && a.color === b.color)) {
            this._actualShouldRender = 2 /* ShouldRenderValue.Needed */;
        }
        ...
        if (backgroundColor) {
            if (backgroundColor.isOpaque()) {
                ...
                canvasCtx.fillStyle = color_js_1.Color.Format.CSS.formatHexA(backgroundColor);
