...
const domReadingContext_js_1 = require("./domReadingContext.js");
const viewLine_js_1 = require("./viewLine.js");
const position_js_1 = require("../../../common/core/position.js");
const range_js_1 = require("../../../common/core/range.js");
const viewLineOptions_js_1 = require("./viewLineOptions.js");
class LastRenderedData {
    constructor() {
        this._currentVisibleRange = new range_js_1.Range(1, 1, 1, 1);
    }
 ...
 * file.
 */
class ViewLines extends viewPart_js_1.ViewPart {
    /**
    ...
    constructor(context, viewGpuContext, linesContent) {
        ...
        this._viewLineOptions = new viewLineOptions_js_1.ViewLineOptions(conf, this._context.theme.type);
        this._linesContent = linesContent;
        this._textRangeRestingSpot = document.createElement('div');
        this._visibleLines = new viewLayer_js_1.VisibleLinesCollection({
            createLine: () => new viewLine_js_1.ViewLine(viewGpuContext, this._viewLineOptions),
        });
        this.domNode = this._visibleLines.domNode;
        viewPart_js_1.PartFingerprints.write(this.domNode, 8 /* PartFingerprint.ViewLines */);
        this.domNode.setClassName(`view-lines ${mouseCursor_js_1.MOUSE_CURSOR_TEXT_CSS_CLASS_NAME}`);
        (0, domFontInfo_js_1.applyFontInfo)(this.domNode, fontInfo);
        // --- width & height
        this._maxLineWidth = 0;
        this._asyncUpdateLineWidths = new async_js_1.RunOnceScheduler(() => {
            this._updateLineWidthsSlow();
        }, 200);
        this._asyncCheckMonospaceFontAssumptions = new async_js_1.RunOnceScheduler(() => {
    ...
    _onOptionsMaybeChanged() {
        const conf = this._context.configuration;
        const newViewLineOptions = new viewLineOptions_js_1.ViewLineOptions(conf, this._context.theme.type);
    ...
    _getViewLineDomNode(node) {
        while (node && node.nodeType === 1) {
            if (node.className === viewLine_js_1.ViewLine.CLASS_NAME) {
                return node;
            }
    ...
    getLineWidth(lineNumber) {
        ...
        const context = new domReadingContext_js_1.DomReadingContext(this.domNode.domNode, this._textRangeRestingSpot);
    ...
    linesVisibleRangesForRange(_range, includeNewLines) {
        ...
        const range = range_js_1.Range.intersectRanges(_range, this._lastRenderedData.getCurrentVisibleRange());
        if (!range) {
            return null;
        }
        const visibleRanges = [];
        let visibleRangesLen = 0;
        const domReadingContext = new domReadingContext_js_1.DomReadingContext(this.domNode.domNode, this._textRangeRestingSpot);
        ...
        for (let lineNumber = range.startLineNumber; lineNumber <= range.endLineNumber; lineNumber++) {
            ...
            visibleRanges[visibleRangesLen++] = new renderingContext_js_1.LineVisibleRanges(visibleRangesForLine.outsideRenderedLine, lineNumber, renderingContext_js_1.HorizontalRange.from(visibleRangesForLine.ranges), continuesInNextLine);
        }
