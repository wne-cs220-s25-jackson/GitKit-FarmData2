 ...
 */
class WhitespaceOverlay extends dynamicViewOverlay_js_1.DynamicViewOverlay {
    constructor(context) {
        super();
    ...
    _applyRenderWhitespace(ctx, lineNumber, selections, lineData) {
        ...
        const color = this._context.theme.getColor(editorColorRegistry_js_1.editorWhitespaces);
        ...
        for (let charIndex = fauxIndentLength; charIndex < len; charIndex++) {
            ...
            const visibleRange = ctx.visibleRangeForPosition(new position_js_1.Position(lineNumber, charIndex + 1));
            if (!visibleRange) {
                continue;
            }
            if (USE_SVG) {
