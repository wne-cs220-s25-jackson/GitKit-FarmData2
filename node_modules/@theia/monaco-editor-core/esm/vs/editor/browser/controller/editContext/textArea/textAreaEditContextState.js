...
exports.TextAreaState = exports._debugComposition = void 0;
...
class TextAreaState {
    ...
    static deduceInput(previousState, currentState, couldBeEmojiInput) {
        ...
        const prefixLength = Math.min((0, strings_js_1.commonPrefixLength)(previousState.value, currentState.value), previousState.selectionStart, currentState.selectionStart);
        const suffixLength = Math.min((0, strings_js_1.commonSuffixLength)(previousState.value, currentState.value), previousState.value.length - previousState.selectionEnd, currentState.value.length - currentState.selectionEnd);
    ...
    static deduceAndroidCompositionInput(previousState, currentState) {
        ...
        const prefixLength = Math.min((0, strings_js_1.commonPrefixLength)(previousState.value, currentState.value), previousState.selectionEnd);
        const suffixLength = Math.min((0, strings_js_1.commonSuffixLength)(previousState.value, currentState.value), previousState.value.length - previousState.selectionEnd);
        const previousValue = previousState.value.substring(prefixLength, previousState.value.length - suffixLength);
        const currentValue = currentState.value.substring(prefixLength, currentState.value.length - suffixLength);
        const previousSelectionStart = previousState.selectionStart - prefixLength;
        const previousSelectionEnd = previousState.selectionEnd - prefixLength;
