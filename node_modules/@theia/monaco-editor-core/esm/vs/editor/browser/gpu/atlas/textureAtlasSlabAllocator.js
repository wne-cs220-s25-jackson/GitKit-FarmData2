...
exports.TextureAtlasSlabAllocator = void 0;
...
class TextureAtlasSlabAllocator {
    constructor(_canvas, _textureIndex, options) {
        ...
        this._slabs = [];
        this._activeSlabsByDims = new map_js_1.TwoKeyMap();
        this._unusedRects = [];
        ...
        this._nextIndex = 0;
        this._ctx = (0, gpuUtils_js_1.ensureNonNullable)(this._canvas.getContext('2d', {
            willReadFrequently: true
        }));
        this._slabW = Math.min(options?.slabW ?? (64 << Math.max(Math.floor((0, dom_js_1.getActiveWindow)().devicePixelRatio) - 1, 0)), this._canvas.width);
    ...
    allocate(rasterizedGlyph) {
        ...
        if (glyphWidth > this._canvas.width || glyphHeight > this._canvas.height) {
            throw new errors_js_1.BugIndicatingError('Glyph is too large for the atlas page');
        }
    ...
    getUsagePreview() {
        ...
        const slabW = 64 << (Math.floor((0, dom_js_1.getActiveWindow)().devicePixelRatio) - 1);
        const slabH = slabW;
...
exports.TextureAtlasSlabAllocator = TextureAtlasSlabAllocator;
