...
(function (GPULifecycle) {
    ...
    function createBuffer(device, descriptor, initialValues) {
        ...
        if (initialValues) {
            device.queue.writeBuffer(buffer, 0, (0, types_js_1.isFunction)(initialValues) ? initialValues() : initialValues);
        }
...
})(GPULifecycle || (exports.GPULifecycle = GPULifecycle = {}));
