...
exports.FullFileRenderStrategy = void 0;
...
const fullFileRenderStrategy_wgsl_js_1 = require("./fullFileRenderStrategy.wgsl.js");
const gpuDisposable_js_1 = require("./gpuDisposable.js");
const gpuUtils_js_1 = require("./gpuUtils.js");
const glyphRasterizer_js_1 = require("./raster/glyphRasterizer.js");
const viewGpuContext_js_1 = require("./viewGpuContext.js");
const color_js_1 = require("../../../base/common/color.js");
class FullFileRenderStrategy extends viewEventHandler_js_1.ViewEventHandler {
    ...
    constructor(_context, _viewGpuContext, _device) {
        ...
        this.wgsl = fullFileRenderStrategy_wgsl_js_1.fullFileRenderStrategyWgsl;
        ...
        this._glyphRasterizer = this._register(new lifecycle_js_1.MandatoryMutableDisposable(new glyphRasterizer_js_1.GlyphRasterizer(fontSize, fontFamily, this._viewGpuContext.devicePixelRatio.get())));
        ...
        this._cellBindBuffer = this._register(gpuDisposable_js_1.GPULifecycle.createBuffer(this._device, {
        ...
        this._scrollOffsetBindBuffer = this._register(gpuDisposable_js_1.GPULifecycle.createBuffer(this._device, {
    ...
    onConfigurationChanged(e) {
        ...
        if (this._glyphRasterizer.value.fontFamily !== fontFamily ||
            ...
            this._glyphRasterizer.value = new glyphRasterizer_js_1.GlyphRasterizer(fontSize, fontFamily, devicePixelRatio);
        }
        return true;
    }
    ...
    onScrollChanged(e) {
        const dpr = (0, dom_js_1.getActiveWindow)().devicePixelRatio;
            ...
            for (let tokenIndex = 0, tokensLen = tokens.getCount(); tokenIndex < tokensLen; tokenIndex++) {
                ...
                for (x = tokenStartIndex; x < tokenEndIndex; x++) {
                    ...
                    for (decoration of lineData.inlineDecorations) {
                        ...
                        const rules = viewGpuContext_js_1.ViewGpuContext.decorationCssRuleExtractor.getStyleRules(this._viewGpuContext.canvas.domNode, decoration.inlineClassName);
                            ...
                            for (const r of rule.style) {
                                ...
                                switch (r) {
                                    case 'color': {
                                        ...
                                        //       to DOM works
                                        const parsedColor = color_js_1.Color.Format.CSS.parse(value);
                                        if (!parsedColor) {
                                            throw new errors_js_1.BugIndicatingError('Invalid color format ' + value);
                                        }
                                        charMetadata = parsedColor.toNumber24Bit();
                                        break;
                                    }
                                    default: throw new errors_js_1.BugIndicatingError('Unexpected inline decoration style');
                                }
                            }
                        }
                    }
                    if (chars === ' ' || chars === '\t') {
                        ...
                        if (chars === '\t') {
                            xOffset = cursorColumns_js_1.CursorColumns.nextRenderTabStop(x + xOffset, lineData.tabSize) - x - 1;
                        }
                        continue;
                    }
    ...
    draw(pass, viewportData) {
        if (this._visibleObjectCount <= 0) {
            throw new errors_js_1.BugIndicatingError('Attempt to draw 0 objects');
        }
        pass.draw(gpuUtils_js_1.quadVertices.length / 2, this._visibleObjectCount, undefined, (viewportData.startLineNumber - 1) * this._viewGpuContext.maxGpuCols);
    }
    /**
...
exports.FullFileRenderStrategy = FullFileRenderStrategy;
