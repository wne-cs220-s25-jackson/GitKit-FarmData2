...
exports.fullFileRenderStrategyWgsl = void 0;
const textureAtlas_js_1 = require("./atlas/textureAtlas.js");
const textureAtlasPage_js_1 = require("./atlas/textureAtlasPage.js");
exports.fullFileRenderStrategyWgsl = `
struct GlyphInfo {
	position: vec2f,
	size: vec2f,
	origin: vec2f,
...
// Storage buffers
@group(0) @binding(${0 /* BindingId.GlyphInfo */})               var<storage, read> glyphInfo:       array<array<GlyphInfo, ${textureAtlasPage_js_1.TextureAtlasPage.maximumGlyphCount}>, ${textureAtlas_js_1.TextureAtlas.maximumPageCount}>;
