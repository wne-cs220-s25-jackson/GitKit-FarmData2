...
exports.DecorationCssRuleExtractor = void 0;
const dom_js_1 = require("../../../base/browser/dom.js");
const lifecycle_js_1 = require("../../../base/common/lifecycle.js");
require("./media/decorationCssRuleExtractor.css");
/**
 * Extracts CSS rules that would be applied to certain decoration classes.
 */
class DecorationCssRuleExtractor extends lifecycle_js_1.Disposable {
    constructor() {
        super();
        this._ruleCache = new Map();
        this._container = (0, dom_js_1.$)('div.monaco-decoration-css-rule-extractor');
        this._dummyElement = (0, dom_js_1.$)('span');
        this._container.appendChild(this._dummyElement);
        this._register((0, lifecycle_js_1.toDisposable)(() => this._container.remove()));
    }
    ...
    _getStyleRules(className) {
        ...
        const rules = [];
        const doc = (0, dom_js_1.getActiveDocument)();
...
exports.DecorationCssRuleExtractor = DecorationCssRuleExtractor;
