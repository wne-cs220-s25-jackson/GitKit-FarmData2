...
class SashLayout {
    ...
    constructor(_options, dimensions) {
        ...
        this.sashLeft = (0, observable_js_1.derivedWithSetter)(this, reader => {
        ...
        this._sashRatio = (0, observable_js_1.observableValue)(this, undefined);
    }
    /** @pure */
...
class DiffEditorSash extends lifecycle_js_1.Disposable {
    constructor(_domNode, _dimensions, _enabled, _boundarySashes, sashLeft, _resetSash) {
        ...
        this._sash = this._register(new sash_js_1.Sash(this._domNode, {
