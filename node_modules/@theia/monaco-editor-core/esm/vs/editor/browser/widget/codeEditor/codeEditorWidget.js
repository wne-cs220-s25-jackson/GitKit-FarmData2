...
require("../../services/markerDecorations.js");
...
const editorConfiguration_js_1 = require("../../config/editorConfiguration.js");
const tabFocus_js_1 = require("../../config/tabFocus.js");
...
const domLineBreaksComputer_js_1 = require("../../view/domLineBreaksComputer.js");
const viewUserInputEvents_js_1 = require("../../view/viewUserInputEvents.js");
const codeEditorContributions_js_1 = require("./codeEditorContributions.js");
...
const editorCommon = require("../../../common/editorCommon.js");
...
const monospaceLineBreaksComputer_js_1 = require("../../../common/viewModel/monospaceLineBreaksComputer.js");
const viewModelImpl_js_1 = require("../../../common/viewModel/viewModelImpl.js");
...
let CodeEditorWidget = class CodeEditorWidget extends lifecycle_js_1.Disposable {
    static { CodeEditorWidget_1 = this; }
    static { this.dropIntoEditorDecorationOptions = textModel_js_1.ModelDecorationOptions.register({
    ...
    constructor(domElement, _options, codeEditorWidgetOptions, instantiationService, codeEditorService, commandService, contextKeyService, themeService, notificationService, accessibilityService, languageConfigurationService, languageFeaturesService) {
        ...
        //#region Eventing
        this._deliveryQueue = (0, event_js_1.createEventDeliveryQueue)();
        this._contributions = this._register(new codeEditorContributions_js_1.CodeEditorContributions());
        this._onDidDispose = this._register(new event_js_1.Emitter());
        this.onDidDispose = this._onDidDispose.event;
        this._onDidChangeModelContent = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelContent = this._onDidChangeModelContent.event;
        this._onDidChangeModelLanguage = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelLanguage = this._onDidChangeModelLanguage.event;
        this._onDidChangeModelLanguageConfiguration = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelLanguageConfiguration = this._onDidChangeModelLanguageConfiguration.event;
        this._onDidChangeModelOptions = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelOptions = this._onDidChangeModelOptions.event;
        this._onDidChangeModelDecorations = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelDecorations = this._onDidChangeModelDecorations.event;
        this._onDidChangeModelTokens = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModelTokens = this._onDidChangeModelTokens.event;
        this._onDidChangeConfiguration = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeConfiguration = this._onDidChangeConfiguration.event;
        this._onWillChangeModel = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onWillChangeModel = this._onWillChangeModel.event;
        this._onDidChangeModel = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeModel = this._onDidChangeModel.event;
        this._onDidChangeCursorPosition = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeCursorPosition = this._onDidChangeCursorPosition.event;
        this._onDidChangeCursorSelection = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        ...
        this._onDidLayoutChange = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        ...
        this._onDidContentSizeChange = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidContentSizeChange = this._onDidContentSizeChange.event;
        this._onDidScrollChange = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidScrollChange = this._onDidScrollChange.event;
        this._onDidChangeViewZones = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeViewZones = this._onDidChangeViewZones.event;
        this._onDidChangeHiddenAreas = this._register(new event_js_1.Emitter({ deliveryQueue: this._deliveryQueue }));
        this.onDidChangeHiddenAreas = this._onDidChangeHiddenAreas.event;
        this._updateCounter = 0;
        this._onWillTriggerEditorOperationEvent = this._register(new event_js_1.Emitter());
        this.onWillTriggerEditorOperationEvent = this._onWillTriggerEditorOperationEvent.event;
        this._onBeginUpdate = this._register(new event_js_1.Emitter());
        this.onBeginUpdate = this._onBeginUpdate.event;
        this._onEndUpdate = this._register(new event_js_1.Emitter());
        this.onEndUpdate = this._onEndUpdate.event;
        this._onBeforeExecuteEdit = this._register(new event_js_1.Emitter());
        ...
        this._configuration = this._register(this._createConfiguration(codeEditorWidgetOptions.isSimpleWidget || false, codeEditorWidgetOptions.contextMenuId ?? (codeEditorWidgetOptions.isSimpleWidget ? actions_js_1.MenuId.SimpleEditorContext : actions_js_1.MenuId.EditorContext), options, accessibilityService));
        ...
        this._instantiationService = this._register(instantiationService.createChild(new serviceCollection_js_1.ServiceCollection([contextkey_js_1.IContextKeyService, this._contextKeyService])));
        ...
        for (const action of editorExtensions_js_1.EditorExtensionsRegistry.getEditorActions()) {
            if (this._actions.has(action.id)) {
                (0, errors_js_1.onUnexpectedError)(new Error(`Cannot have two actions with the same id ${action.id}`));
                continue;
            }
            const internalAction = new editorAction_js_1.InternalEditorAction(action.id, action.label, action.alias, action.metadata, action.precondition ?? undefined, (args) => {
    ...
    _createConfiguration(isSimpleWidget, contextMenuId, options, accessibilityService) {
        return new editorConfiguration_js_1.EditorConfiguration(isSimpleWidget, contextMenuId, options, this._domElement, accessibilityService);
    }
    getId() {
    ...
    getConfiguredWordAtPosition(position) {
        ...
        return cursorWordOperations_js_1.WordOperations.getWordAtPosition(this._modelData.model, this._configuration.options.get(136 /* EditorOption.wordSeparators */), this._configuration.options.get(135 /* EditorOption.wordSegmenterLocales */), position);
    }
    ...
    setHiddenAreas(ranges, source, forceUpdate) {
        this._modelData?.viewModel.setHiddenAreas(ranges.map(r => range_js_1.Range.lift(r)), source, forceUpdate);
    }
    getVisibleColumnFromPosition(rawPosition) {
        ...
        return cursorColumns_js_1.CursorColumns.visibleColumnFromColumn(this._modelData.model.getLineContent(position.lineNumber), position.column, tabSize) + 1;
    }
    getStatusbarColumn(rawPosition) {
        ...
        const position = this._modelData.model.validatePosition(rawPosition);
        const tabSize = this._modelData.model.getOptions().tabSize;
        return cursorColumns_js_1.CursorColumns.toStatusbarColumn(this._modelData.model.getLineContent(position.lineNumber), position.column, tabSize);
    }
    getPosition() {
        if (!this._modelData) {
            return null;
    ...
    setSelection(something, source = 'api') {
        const isSelection = selection_js_1.Selection.isISelection(something);
        const isRange = range_js_1.Range.isIRange(something);
    ...
    _setSelectionImpl(sel, source) {
        ...
        const selection = new selection_js_1.Selection(sel.selectionStartLineNumber, sel.selectionStartColumn, sel.positionLineNumber, sel.positionColumn);
    ...
    trigger(source, handlerId, payload) {
        ...
        try {
            ...
            if (action) {
                Promise.resolve(action.run(payload)).then(undefined, errors_js_1.onUnexpectedError);
                return;
            }
            if (!this._modelData) {
                return;
    ...
    _paste(source, text, pasteOnNewLine, multicursorText, mode, clipboardEvent) {
        ...
        if (source === 'keyboard') {
            this._onDidPaste.fire({
                clipboardEvent,
                range: new range_js_1.Range(startPosition.lineNumber, startPosition.column, endPosition.lineNumber, endPosition.column),
                languageId: mode
            });
        }
    }
    ...
    _triggerEditorCommand(source, handlerId, payload) {
        const command = editorExtensions_js_1.EditorExtensionsRegistry.getEditorCommand(handlerId);
        if (command) {
            payload = payload || {};
            payload.source = source;
            this._instantiationService.invokeFunction((accessor) => {
                Promise.resolve(command.runEditorCommand(accessor, this, payload)).then(undefined, errors_js_1.onUnexpectedError);
            });
            return true;
        }
        return false;
    ...
    getLineDecorations(lineNumber) {
        ...
        return this._modelData.model.getLineDecorations(lineNumber, this._id, (0, editorOptions_js_1.filterValidationDecorations)(this._configuration.options));
    }
    getDecorationsInRange(range) {
        if (!this._modelData) {
            return null;
        }
        return this._modelData.model.getDecorationsInRange(range, this._id, (0, editorOptions_js_1.filterValidationDecorations)(this._configuration.options));
    }
    /**
     * @deprecated
     */
    ...
    setDecorationsByType(description, decorationTypeKey, decorationOptions) {
        ...
        for (const decorationOption of decorationOptions) {
            ...
            if (decorationOption.renderOptions) {
                ...
                const subType = (0, hash_js_1.hash)(decorationOption.renderOptions).toString(16);
    ...
    setDecorationsByTypeFast(decorationTypeKey, ranges) {
        ...
        const opts = textModel_js_1.ModelDecorationOptions.createDynamic(this._resolveDecorationOptions(decorationTypeKey, false));
    ...
    applyFontInfo(target) {
        (0, domFontInfo_js_1.applyFontInfo)(target, this._configuration.options.get(52 /* EditorOption.fontInfo */));
    }
            ...
            switch (e.kind) {
                ...
                case 6 /* OutgoingViewModelEventKind.CursorStateChanged */: {
                    if (e.reachedMaxCursorCount) {
                        ...
                        this._notificationService.prompt(notification_js_1.Severity.Warning, message, [
                            {
    ...
    _createView(viewModel) {
        ...
        const viewUserInputEvents = new viewUserInputEvents_js_1.ViewUserInputEvents(viewModel.coordinatesConverter);
        ...
        const view = new view_js_1.View(this.getId(), commandDelegate, this._configuration, this._themeService.getColorTheme(), viewModel, viewUserInputEvents, this._overflowWidgetsDomNode, this._instantiationService);
        return [view, true];
    }
...
exports.CodeEditorWidget = CodeEditorWidget = CodeEditorWidget_1 = __decorate([
    ...
    __param(10, languageConfigurationRegistry_js_1.ILanguageConfigurationService),
    __param(11, languageFeatures_js_1.ILanguageFeaturesService)
], CodeEditorWidget);
let EDITOR_ID = 0;
class ModelData {
    ...
    dispose() {
        (0, lifecycle_js_1.dispose)(this.listenersToRemove);
...
class BooleanEventEmitter extends lifecycle_js_1.Disposable {
    constructor(_emitterOptions) {
        super();
        this._emitterOptions = _emitterOptions;
        this._onDidChangeToTrue = this._register(new event_js_1.Emitter(this._emitterOptions));
        this.onDidChangeToTrue = this._onDidChangeToTrue.event;
        this._onDidChangeToFalse = this._register(new event_js_1.Emitter(this._emitterOptions));
 ...
 */
class InteractionEmitter extends event_js_1.Emitter {
...
class EditorContextKeysManager extends lifecycle_js_1.Disposable {
    constructor(editor, contextKeyService) {
        super();
        this._editor = editor;
        contextKeyService.createKey('editorId', editor.getId());
        this._editorSimpleInput = editorContextKeys_js_1.EditorContextKeys.editorSimpleInput.bindTo(contextKeyService);
        this._editorFocus = editorContextKeys_js_1.EditorContextKeys.focus.bindTo(contextKeyService);
        this._textInputFocus = editorContextKeys_js_1.EditorContextKeys.textInputFocus.bindTo(contextKeyService);
        this._editorTextFocus = editorContextKeys_js_1.EditorContextKeys.editorTextFocus.bindTo(contextKeyService);
        this._tabMovesFocus = editorContextKeys_js_1.EditorContextKeys.tabMovesFocus.bindTo(contextKeyService);
        this._editorReadonly = editorContextKeys_js_1.EditorContextKeys.readOnly.bindTo(contextKeyService);
        this._inDiffEditor = editorContextKeys_js_1.EditorContextKeys.inDiffEditor.bindTo(contextKeyService);
        this._editorColumnSelection = editorContextKeys_js_1.EditorContextKeys.columnSelection.bindTo(contextKeyService);
        this._hasMultipleSelections = editorContextKeys_js_1.EditorContextKeys.hasMultipleSelections.bindTo(contextKeyService);
        this._hasNonEmptySelection = editorContextKeys_js_1.EditorContextKeys.hasNonEmptySelection.bindTo(contextKeyService);
        this._canUndo = editorContextKeys_js_1.EditorContextKeys.canUndo.bindTo(contextKeyService);
        this._canRedo = editorContextKeys_js_1.EditorContextKeys.canRedo.bindTo(contextKeyService);
        ...
        this._register(tabFocus_js_1.TabFocus.onDidChangeTabFocus((tabFocusMode) => this._tabMovesFocus.set(tabFocusMode)));
    ...
    _updateFromConfig() {
        ...
        this._tabMovesFocus.set(tabFocus_js_1.TabFocus.getTabFocusMode());
...
class EditorModeContext extends lifecycle_js_1.Disposable {
    constructor(_editor, _contextKeyService, _languageFeaturesService) {
        super();
        this._editor = _editor;
        this._contextKeyService = _contextKeyService;
        this._languageFeaturesService = _languageFeaturesService;
        this._langId = editorContextKeys_js_1.EditorContextKeys.languageId.bindTo(_contextKeyService);
        this._hasCompletionItemProvider = editorContextKeys_js_1.EditorContextKeys.hasCompletionItemProvider.bindTo(_contextKeyService);
        this._hasCodeActionsProvider = editorContextKeys_js_1.EditorContextKeys.hasCodeActionsProvider.bindTo(_contextKeyService);
        this._hasCodeLensProvider = editorContextKeys_js_1.EditorContextKeys.hasCodeLensProvider.bindTo(_contextKeyService);
        this._hasDefinitionProvider = editorContextKeys_js_1.EditorContextKeys.hasDefinitionProvider.bindTo(_contextKeyService);
        this._hasDeclarationProvider = editorContextKeys_js_1.EditorContextKeys.hasDeclarationProvider.bindTo(_contextKeyService);
        this._hasImplementationProvider = editorContextKeys_js_1.EditorContextKeys.hasImplementationProvider.bindTo(_contextKeyService);
        this._hasTypeDefinitionProvider = editorContextKeys_js_1.EditorContextKeys.hasTypeDefinitionProvider.bindTo(_contextKeyService);
        this._hasHoverProvider = editorContextKeys_js_1.EditorContextKeys.hasHoverProvider.bindTo(_contextKeyService);
        this._hasDocumentHighlightProvider = editorContextKeys_js_1.EditorContextKeys.hasDocumentHighlightProvider.bindTo(_contextKeyService);
        this._hasDocumentSymbolProvider = editorContextKeys_js_1.EditorContextKeys.hasDocumentSymbolProvider.bindTo(_contextKeyService);
        this._hasReferenceProvider = editorContextKeys_js_1.EditorContextKeys.hasReferenceProvider.bindTo(_contextKeyService);
        this._hasRenameProvider = editorContextKeys_js_1.EditorContextKeys.hasRenameProvider.bindTo(_contextKeyService);
        this._hasSignatureHelpProvider = editorContextKeys_js_1.EditorContextKeys.hasSignatureHelpProvider.bindTo(_contextKeyService);
        this._hasInlayHintsProvider = editorContextKeys_js_1.EditorContextKeys.hasInlayHintsProvider.bindTo(_contextKeyService);
        this._hasDocumentFormattingProvider = editorContextKeys_js_1.EditorContextKeys.hasDocumentFormattingProvider.bindTo(_contextKeyService);
        this._hasDocumentSelectionFormattingProvider = editorContextKeys_js_1.EditorContextKeys.hasDocumentSelectionFormattingProvider.bindTo(_contextKeyService);
        this._hasMultipleDocumentFormattingProvider = editorContextKeys_js_1.EditorContextKeys.hasMultipleDocumentFormattingProvider.bindTo(_contextKeyService);
        this._hasMultipleDocumentSelectionFormattingProvider = editorContextKeys_js_1.EditorContextKeys.hasMultipleDocumentSelectionFormattingProvider.bindTo(_contextKeyService);
        this._isInEmbeddedEditor = editorContextKeys_js_1.EditorContextKeys.isInEmbeddedEditor.bindTo(_contextKeyService);
    ...
    _update() {
        ...
        this._contextKeyService.bufferChangeEvents(() => {
            ...
            this._isInEmbeddedEditor.set(model.uri.scheme === network_js_1.Schemas.walkThroughSnippet || model.uri.scheme === network_js_1.Schemas.vscodeChatCodeBlock);
        });
    }
}
exports.EditorModeContext = EditorModeContext;
class CodeEditorWidgetFocusTracker extends lifecycle_js_1.Disposable {
    constructor(domElement, overflowWidgetsDomNode) {
        super();
        this._onChange = this._register(new event_js_1.Emitter());
...
(0, themeService_js_1.registerThemingParticipant)((theme, collector) => {
    const errorForeground = theme.getColor(colorRegistry_js_1.editorErrorForeground);
    if (errorForeground) {
    ...
    const warningForeground = theme.getColor(colorRegistry_js_1.editorWarningForeground);
    ...
    const infoForeground = theme.getColor(colorRegistry_js_1.editorInfoForeground);
    if (infoForeground) {
    ...
    const hintForeground = theme.getColor(colorRegistry_js_1.editorHintForeground);
    if (hintForeground) {
    ...
    const unnecessaryForeground = theme.getColor(editorColorRegistry_js_1.editorUnnecessaryCodeOpacity);
