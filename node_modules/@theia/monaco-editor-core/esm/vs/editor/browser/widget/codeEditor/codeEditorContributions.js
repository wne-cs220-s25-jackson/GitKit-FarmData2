...
class CodeEditorContributions extends lifecycle_js_1.Disposable {
    constructor() {
        super();
        this._editor = null;
         ...
         */
        this._instances = this._register(new lifecycle_js_1.DisposableMap());
        /**
    ...
    initialize(editor, contributions, instantiationService) {
        ...
        for (const desc of contributions) {
            if (this._pending.has(desc.id)) {
                (0, errors_js_1.onUnexpectedError)(new Error(`Cannot have two contributions with the same id ${desc.id}`));
                continue;
            }
        ...
        this._register((0, dom_js_1.runWhenWindowIdle)((0, dom_js_1.getWindow)(this._editor.getDomNode()), () => {
    ...
    onAfterModelAttached() {
        return (0, dom_js_1.runWhenWindowIdle)((0, dom_js_1.getWindow)(this._editor?.getDomNode()), () => {
            this._instantiateSome(1 /* EditorContributionInstantiation.AfterFirstRender */);
        }, 50);
    }
