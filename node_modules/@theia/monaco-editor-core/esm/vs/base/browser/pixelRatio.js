 ...
 */
class DevicePixelRatioMonitor extends lifecycle_js_1.Disposable {
...
class PixelRatioMonitorImpl extends lifecycle_js_1.Disposable {
    get value() {
        return this._value;
    }
    constructor(targetWindow) {
...
class PixelRatioMonitorFacade {
    ...
    _getOrCreatePixelRatioMonitor(targetWindow) {
        const targetWindowId = (0, dom_js_1.getWindowId)(targetWindow);
        let pixelRatioMonitor = this.mapWindowIdToPixelRatioMonitor.get(targetWindowId);
        if (!pixelRatioMonitor) {
            pixelRatioMonitor = (0, lifecycle_js_1.markAsSingleton)(new PixelRatioMonitorImpl(targetWindow));
            this.mapWindowIdToPixelRatioMonitor.set(targetWindowId, pixelRatioMonitor);
            (0, lifecycle_js_1.markAsSingleton)(event_js_1.Event.once(dom_js_1.onDidUnregisterWindow)(({ vscodeWindowId }) => {
