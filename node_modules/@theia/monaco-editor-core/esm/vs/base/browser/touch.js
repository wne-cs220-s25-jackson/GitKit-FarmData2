...
const linkedList_js_1 = require("../common/linkedList.js");
var EventType;
(function (EventType) {
...
class Gesture extends lifecycle_js_1.Disposable {
    ...
    constructor() {
        ...
        this.targets = new linkedList_js_1.LinkedList();
        this.ignoreTargets = new linkedList_js_1.LinkedList();
        this.activeTouches = {};
        this.handle = null;
        this._lastSetTapCountTime = 0;
        this._register(event_js_1.Event.runAndSubscribe(DomUtils.onDidRegisterWindow, ({ window, disposables }) => {
        ...
        }, { window: window_js_1.mainWindow, disposables: this._store }));
    }
    static addTarget(element) {
        ...
        if (!Gesture.INSTANCE) {
            Gesture.INSTANCE = (0, lifecycle_js_1.markAsSingleton)(new Gesture());
        }
        const remove = Gesture.INSTANCE.targets.push(element);
        return (0, lifecycle_js_1.toDisposable)(remove);
    }
    ...
    static isTouchDevice() {
        ...
        return 'ontouchstart' in window_js_1.mainWindow || navigator.maxTouchPoints > 0;
    }
    dispose() {
        if (this.handle) {
            this.handle.dispose();
