...
const errorMessage_js_1 = require("../common/errorMessage.js");
const errors_js_1 = require("../common/errors.js");
const performance_js_1 = require("../common/performance.js");
...
class IndexedDB {
    ...
    static async openDatabase(name, version, stores) {
        (0, performance_js_1.mark)(`code/willOpenDatabase/${name}`);
        try {
            ...
            if (err instanceof MissingStoresError) {
                ...
                try {
                    ...
                    console.error(`Error while deleting the IndexedDB`, (0, errors_js_1.getErrorMessage)(error));
                    throw error;
                }
                return await IndexedDB.doOpenDatabase(name, version, stores);
            }
            ...
            (0, performance_js_1.mark)(`code/didOpenDatabase/${name}`);
        }
    }
    ...
    async runInTransaction(store, transactionMode, dbRequestFn) {
        ...
        return new Promise((c, e) => {
            ...
            transaction.onerror = () => e(transaction.error ? errors_js_1.ErrorNoTelemetry.fromError(transaction.error) : new errors_js_1.ErrorNoTelemetry('unknown error'));
            transaction.onabort = () => e(transaction.error ? errors_js_1.ErrorNoTelemetry.fromError(transaction.error) : new errors_js_1.ErrorNoTelemetry('unknown error'));
    ...
    async getKeyValues(store, isValid) {
        ...
        return new Promise(resolve => {
            ...
            // Error handlers
            const onError = (error) => {
                console.error(`IndexedDB getKeyValues(): ${(0, errorMessage_js_1.toErrorMessage)(error, true)}`);
                resolve(items);
            };
