...
const keybindings_js_1 = require("../common/keybindings.js");
const platform = require("../common/platform.js");
function extractKeyCode(e) {
    if (e.charCode) {
        // "keypress" events mostly
        const char = String.fromCharCode(e.charCode).toUpperCase();
        return keyCodes_js_1.KeyCodeUtils.fromString(char);
    }
    ...
    return keyCodes_js_1.EVENT_KEY_CODE_MAP[keyCode] || 0 /* KeyCode.Unknown */;
}
...
function printStandardKeyboardEvent(e) {
    ...
    return `modifiers: [${modifiers.join(',')}], code: ${e.code}, keyCode: ${e.keyCode} ('${keyCodes_js_1.KeyCodeUtils.toString(e.keyCode)}')`;
}
class StandardKeyboardEvent {
    ...
    _computeKeyCodeChord() {
        ...
        return new keybindings_js_1.KeyCodeChord(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, key);
    }
}
