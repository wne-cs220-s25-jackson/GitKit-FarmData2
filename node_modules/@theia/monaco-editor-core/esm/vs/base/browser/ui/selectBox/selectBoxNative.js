...
class SelectBoxNative extends lifecycle_js_1.Disposable {
    ...
    registerListeners() {
        this._register(touch_js_1.Gesture.addTarget(this.selectElement));
        [touch_js_1.EventType.Tap].forEach(eventType => {
