...
class ContextView extends lifecycle_js_1.Disposable {
    ...
    constructor(container, domPosition) {
        ...
        this.delegate = null;
        this.toDisposeOnClean = lifecycle_js_1.Disposable.None;
        this.toDisposeOnSetContainer = lifecycle_js_1.Disposable.None;
        this.shadowRoot = null;
        this.shadowRootHostElement = null;
        this.view = DOM.$('.context-view');
        DOM.hide(this.view);
        this.setContainer(container, domPosition);
        this._register((0, lifecycle_js_1.toDisposable)(() => this.setContainer(null, 1 /* ContextViewDOMPosition.ABSOLUTE */)));
    }
    setContainer(container, domPosition) {
        ...
        if (container) {
            ...
            const toDisposeOnSetContainer = new lifecycle_js_1.DisposableStore();
    ...
    show(delegate) {
        ...
        DOM.show(this.view);
        // Render content
        this.toDisposeOnClean = delegate.render(this.view) || lifecycle_js_1.Disposable.None;
        // Set active delegate
    ...
    layout() {
        ...
        if (this.delegate.canRelayout === false && !(platform.isIOS && canIUse_js_1.BrowserFeatures.pointerEvents)) {
            this.hide();
            return;
        }
    ...
    doLayout() {
        ...
        if (anchorAxisAlignment === 0 /* AnchorAxisAlignment.VERTICAL */) {
            ...
            if (range_js_1.Range.intersects({ start: top, end: top + viewSizeHeight }, { start: verticalAnchor.offset, end: verticalAnchor.offset + verticalAnchor.size })) {
            ...
            if (range_js_1.Range.intersects({ start: left, end: left + viewSizeWidth }, { start: horizontalAnchor.offset, end: horizontalAnchor.offset + horizontalAnchor.size })) {
