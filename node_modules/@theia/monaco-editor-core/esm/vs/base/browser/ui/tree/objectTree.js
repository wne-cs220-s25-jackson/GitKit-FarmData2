...
const compressedObjectTreeModel_js_1 = require("./compressedObjectTreeModel.js");
...
class ObjectTree extends abstractTree_js_1.AbstractTree {
    ...
    createModel(user, options) {
        return new objectTreeModel_js_1.ObjectTreeModel(user, options);
    }
}
...
class CompressibleObjectTree extends ObjectTree {
    ...
    createModel(user, options) {
        return new compressedObjectTreeModel_js_1.CompressibleObjectTreeModel(user, options);
    }
