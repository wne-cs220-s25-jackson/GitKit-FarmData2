...
class BreadcrumbsWidget {
    constructor(container, horizontalScrollbarSize, separatorIcon, styles) {
        ...
        this._onDidSelectItem = new event_js_1.Emitter();
        this._onDidFocusItem = new event_js_1.Emitter();
        this._onDidChangeFocus = new event_js_1.Emitter();
        ...
        this._scrollable = new scrollableElement_js_1.DomScrollableElement(this._domNode, {
    ...
    setItems(items) {
        ...
        let removed = [];
        try {
            prefix = (0, arrays_js_1.commonPrefixLength)(this._items, items, (a, b) => a.equals(b));
            removed = this._items.splice(prefix, this._items.length - prefix, ...items.slice(prefix));
            this._render(prefix);
            (0, lifecycle_js_1.dispose)(removed);
    ...
    _renderItem(item, container) {
        ...
        const iconContainer = dom.$(themables_js_1.ThemeIcon.asCSSSelector(this._separatorIcon));
