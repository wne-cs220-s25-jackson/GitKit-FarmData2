...
const fastDomNode_js_1 = require("../../fastDomNode.js");
const mouseEvent_js_1 = require("../../mouseEvent.js");
const horizontalScrollbar_js_1 = require("./horizontalScrollbar.js");
const verticalScrollbar_js_1 = require("./verticalScrollbar.js");
...
class MouseWheelClassifier {
    ...
    acceptStandardWheelEvent(e) {
        if (browser_js_1.isChrome) {
            const targetWindow = dom.getWindow(e.browserEvent);
            const pageZoomFactor = (0, browser_js_1.getZoomFactor)(targetWindow);
...
class AbstractScrollableElement extends widget_js_1.Widget {
    get options() {
        return this._options;
    }
    constructor(element, options, scrollable) {
        super();
        this._onScroll = this._register(new event_js_1.Emitter());
        this.onScroll = this._onScroll.event;
        this._onWillScroll = this._register(new event_js_1.Emitter());
        ...
        this._verticalScrollbar = this._register(new verticalScrollbar_js_1.VerticalScrollbar(this._scrollable, this._options, scrollbarHost));
        this._horizontalScrollbar = this._register(new horizontalScrollbar_js_1.HorizontalScrollbar(this._scrollable, this._options, scrollbarHost));
        ...
        if (this._options.useShadows) {
            this._leftShadowDomNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
            this._leftShadowDomNode.setClassName('shadow');
            this._domNode.appendChild(this._leftShadowDomNode.domNode);
            this._topShadowDomNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
            this._topShadowDomNode.setClassName('shadow');
            this._domNode.appendChild(this._topShadowDomNode.domNode);
            this._topLeftShadowDomNode = (0, fastDomNode_js_1.createFastDomNode)(document.createElement('div'));
        ...
        this._hideTimeout = this._register(new async_js_1.TimeoutTimer());
    ...
    dispose() {
        this._mouseWheelToDispose = (0, lifecycle_js_1.dispose)(this._mouseWheelToDispose);
        super.dispose();
    }
    /**
    ...
    delegateScrollFromMouseWheelEvent(browserEvent) {
        this._onMouseWheel(new mouseEvent_js_1.StandardWheelEvent(browserEvent));
    }
...
class ScrollableElement extends AbstractScrollableElement {
    constructor(element, options) {
        ...
        const scrollable = new scrollable_js_1.Scrollable({
