...
const aria = require("../aria/aria.js");
...
const history_js_1 = require("../../../common/history.js");
...
class InputBox extends widget_js_1.Widget {
    constructor(container, contextViewProvider, options) {
        ...
        this._onDidHeightChange = this._register(new event_js_2.Emitter());
        ...
        if (this.options.flexibleHeight) {
            ...
            this.scrollableElement = new scrollableElement_js_1.ScrollableElement(this.element, { vertical: 1 /* ScrollbarVisibility.Auto */ });
            ...
            const onSelectionChange = this._register(new event_js_1.DomEmitter(container.ownerDocument, 'selectionchange'));
            const onAnchoredSelectionChange = event_js_2.Event.filter(onSelectionChange.event, () => {
        ...
        if (this.options.actions) {
            this.actionbar = this._register(new actionbar_js_1.ActionBar(this.element));
    ...
    setTooltip(tooltip) {
        ...
        if (!this.hover.value) {
            this.hover.value = this._register((0, hoverDelegate2_js_1.getBaseLayerHoverDelegate)().setupDelayedHoverAtMouse(this.input, () => ({
                content: tooltip,
                appearance: {
                    compact: true,
                }
    ...
    showMessage(message, force) {
        if (this.state === 'open' && (0, objects_js_1.equals)(this.message, message)) {
            // Already showing
            return;
        }
        ...
        this.contextViewProvider.showContextView({
            ...
            render: (container) => {
                ...
                const spanElement = (this.message.formatContent
                    ? (0, formattedTextRenderer_js_1.renderFormattedText)(this.message.content, renderOptions)
                    : (0, formattedTextRenderer_js_1.renderText)(this.message.content, renderOptions));
...
class HistoryInputBox extends InputBox {
    constructor(container, contextViewProvider, options) {
        ...
        this._onDidFocus = this._register(new event_js_2.Emitter());
        this.onDidFocus = this._onDidFocus.event;
        this._onDidBlur = this._register(new event_js_2.Emitter());
        this.onDidBlur = this._onDidBlur.event;
        this.history = new history_js_1.HistoryNavigator(options.history, 100);
