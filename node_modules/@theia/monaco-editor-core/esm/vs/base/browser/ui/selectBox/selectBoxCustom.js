...
const domStylesheetsJs = require("../../domStylesheets.js");
const cssJs = require("../../cssValue.js");
...
const arrays = require("../../../common/arrays.js");
const event_js_2 = require("../../../common/event.js");
const keyCodes_js_1 = require("../../../common/keyCodes.js");
...
class SelectBoxList extends lifecycle_js_1.Disposable {
    ...
    constructor(options, selected, contextViewProvider, styles, selectBoxOptions) {
        ...
        this._onDidSelect = new event_js_2.Emitter();
    ...
    setTitle(title) {
        if (!this._hover && title) {
            this._hover = this._register((0, hoverDelegate2_js_1.getBaseLayerHoverDelegate)().setupManagedHover((0, hoverDelegateFactory_js_1.getDefaultHoverDelegate)('mouse'), this.selectElement, title));
        }
        else if (this._hover) {
    ...
    createSelectList(parent) {
        ...
        this.selectList = this._register(new listWidget_js_1.List('SelectBoxCustom', this.selectDropDownListContainer, this, [this.listRenderer], {
            useShadows: false,
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => (0, nls_js_1.localize)({ key: 'selectBox', comment: ['Behave like native select dropdown element.'] }, "Select Box"),
                getRole: () => platform_js_1.isMacintosh ? '' : 'option',
        ...
        const onKeyDown = this._register(new event_js_1.DomEmitter(this.selectDropDownListContainer, 'keydown'));
        const onSelectDropDownKeyDown = event_js_2.Event.chain(onKeyDown.event, $ => $.filter(() => this.selectList.length > 0)
            .map(e => new keyboardEvent_js_1.StandardKeyboardEvent(e)));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 3 /* KeyCode.Enter */))(this.onEnter, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 2 /* KeyCode.Tab */))(this.onEnter, this)); // Tab should behave the same as enter, #79339
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 9 /* KeyCode.Escape */))(this.onEscape, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 16 /* KeyCode.UpArrow */))(this.onUpArrow, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 18 /* KeyCode.DownArrow */))(this.onDownArrow, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 12 /* KeyCode.PageDown */))(this.onPageDown, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 11 /* KeyCode.PageUp */))(this.onPageUp, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 14 /* KeyCode.Home */))(this.onHome, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => e.keyCode === 13 /* KeyCode.End */))(this.onEnd, this));
        this._register(event_js_2.Event.chain(onSelectDropDownKeyDown, $ => $.filter(e => (e.keyCode >= 21 /* KeyCode.Digit0 */ && e.keyCode <= 56 /* KeyCode.KeyZ */) || (e.keyCode >= 85 /* KeyCode.Semicolon */ && e.keyCode <= 113 /* KeyCode.NumpadDivide */)))(this.onCharacter, this));
    ...
    renderDescriptionMarkdown(text, actionHandler) {
        ...
        const rendered = (0, markdownRenderer_js_1.renderMarkdown)({ value: text, supportThemeIcons: true }, { actionHandler });
    ...
    onCharacter(e) {
        const ch = keyCodes_js_1.KeyCodeUtils.toString(e.keyCode);
        let optionIndex = -1;
