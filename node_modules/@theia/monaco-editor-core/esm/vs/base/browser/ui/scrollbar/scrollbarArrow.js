...
class ScrollbarArrow extends widget_js_1.Widget {
    constructor(opts) {
        super();
        ...
        this.domNode.classList.add(...themables_js_1.ThemeIcon.asClassNameArray(opts.icon));
        ...
        this._pointerdownScheduleRepeatTimer = this._register(new async_js_1.TimeoutTimer());
    }
    _arrowPointerDown(e) {
