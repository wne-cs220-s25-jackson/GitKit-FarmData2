...
class Storage extends lifecycle_js_1.Disposable {
    static { this.DEFAULT_FLUSH_DELAY = 100; }
    constructor(database, options = Object.create(null)) {
        super();
        this.database = database;
        this.options = options;
        this._onDidChangeStorage = this._register(new event_js_1.PauseableEmitter());
        this.onDidChangeStorage = this._onDidChangeStorage.event;
        this.state = StorageState.None;
        this.cache = new Map();
        this.flushDelayer = this._register(new async_js_1.ThrottledDelayer(Storage.DEFAULT_FLUSH_DELAY));
    ...
    acceptExternal(key, value) {
        ...
        if ((0, types_js_1.isUndefinedOrNull)(value)) {
    ...
    getObject(key, fallbackValue) {
        ...
        return (0, marshalling_js_1.parse)(value);
    }
    async set(key, value, external = false) {
        ...
        const valueStr = (0, types_js_1.isObject)(value) || Array.isArray(value) ? (0, marshalling_js_1.stringify)(value) : String(value);
...
class InMemoryStorageDatabase {
    constructor() {
        this.onDidChangeItemsExternal = event_js_1.Event.None;
        this.items = new Map();
    }
    async getItems() {
        return this.items;
