...
const korean_js_1 = require("./naturalLanguage/korean.js");
...
function getAlternateCodes(code) {
    ...
    let result;
    const codes = (0, korean_js_1.getKoreanAltChars)(code);
    if (codes) {
        result = codes;
    }
...
const fuzzyRegExpCache = new map_js_1.LRUCache(10000); // bounded to 10000 elements
