...
const intlFileNameCollatorBaseNumeric = new lazy_js_1.Lazy(() => {
...
const intlFileNameCollatorNumeric = new lazy_js_1.Lazy(() => {
...
const intlFileNameCollatorNumericCaseInsensitive = new lazy_js_1.Lazy(() => {
...
function comparePaths(one, other, caseSensitive = false) {
    const oneParts = one.split(path_js_1.sep);
    const otherParts = other.split(path_js_1.sep);
