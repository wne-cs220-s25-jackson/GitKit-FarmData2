...
class HistoryNavigator {
    ...
    _onChange() {
        ...
        this._navigator = new navigator_js_1.ArrayNavigator(elements, 0, elements.length, elements.length);
    }
    _reduceToLimit() {
...
class HistoryNavigator2 {
    ...
    constructor(history, capacity = 10, identityFn = t => t) {
        ...
        this.valueSet = new collections_js_1.SetWithKey([history[0]], identityFn);
