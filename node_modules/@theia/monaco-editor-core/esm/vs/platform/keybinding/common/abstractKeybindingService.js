...
const keybindingResolver_js_1 = require("./keybindingResolver.js");
const HIGH_FREQ_COMMANDS = /^(cursor|delete|undo|redo|tab|editor\.action\.clipboard)/;
class AbstractKeybindingService extends lifecycle_js_1.Disposable {
    get onDidUpdateKeybindings() {
        return this._onDidUpdateKeybindings ? this._onDidUpdateKeybindings.event : event_js_1.Event.None; // Sinon stubbing walks properties on prototype
    }
    get inChordMode() {
    ...
    constructor(_contextKeyService, _commandService, _telemetryService, _notificationService, _logService) {
        ...
        this._onDidUpdateKeybindings = this._register(new event_js_1.Emitter());
        this._currentChords = [];
        this._currentChordChecker = new async_js_1.IntervalTimer();
        this._currentChordStatusMessage = null;
        this._ignoreSingleModifiers = KeybindingModifierSet.EMPTY;
        this._currentSingleModifier = null;
        this._currentSingleModifierClearTimeout = new async_js_1.TimeoutTimer();
    ...
    softDispatch(e, target) {
        ...
        if (keybinding.hasMultipleChords()) {
            ...
            return keybindingResolver_js_1.NoMatchingKb;
        }
    ...
    _expectAnotherChord(firstChord, keypressLabel) {
        ...
        switch (this._currentChords.length) {
            case 0:
                throw (0, errors_js_1.illegalState)('impossible');
            case 1:
        ...
        if (ime_js_1.IME.enabled) {
            ime_js_1.IME.disable();
        }
    }
    _leaveChordMode() {
