...
const baseResolvedKeybinding_js_1 = require("./baseResolvedKeybinding.js");
const resolvedKeybindingItem_js_1 = require("./resolvedKeybindingItem.js");
/**
 * Do not instantiate. Use KeybindingService to get a ResolvedKeybinding seeded with information about the current kb layout.
 */
class USLayoutResolvedKeybinding extends baseResolvedKeybinding_js_1.BaseResolvedKeybinding {
    ...
    _keyCodeToUILabel(keyCode) {
        ...
        return keyCodes_js_1.KeyCodeUtils.toString(keyCode);
    }
    _getLabel(chord) {
    ...
    _getAriaLabel(chord) {
        ...
        return keyCodes_js_1.KeyCodeUtils.toString(chord.keyCode);
    }
    _getElectronAccelerator(chord) {
        return keyCodes_js_1.KeyCodeUtils.toElectronAccelerator(chord.keyCode);
    }
    _getUserSettingsLabel(chord) {
        if (chord.isDuplicateModifierCase()) {
            return '';
        }
        const result = keyCodes_js_1.KeyCodeUtils.toUserSettingsUS(chord.keyCode);
    ...
    static getDispatchStr(chord) {
        ...
        result += keyCodes_js_1.KeyCodeUtils.toString(chord.keyCode);
        return result;
    }
    ...
    static _scanCodeToKeyCode(scanCode) {
        const immutableKeyCode = keyCodes_js_1.IMMUTABLE_CODE_TO_KEY_CODE[scanCode];
    ...
    static _toKeyCodeChord(chord) {
        ...
        if (chord instanceof keybindings_js_1.KeyCodeChord) {
            return chord;
        }
        ...
        return new keybindings_js_1.KeyCodeChord(chord.ctrlKey, chord.shiftKey, chord.altKey, chord.metaKey, keyCode);
    }
    static resolveKeybinding(keybinding, os) {
        const chords = (0, resolvedKeybindingItem_js_1.toEmptyArrayIfContainsNull)(keybinding.chords.map(chord => this._toKeyCodeChord(chord)));
        if (chords.length > 0) {
