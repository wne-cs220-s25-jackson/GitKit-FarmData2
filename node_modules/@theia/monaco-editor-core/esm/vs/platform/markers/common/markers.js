...
(function (MarkerSeverity) {
    ...
    _displayStrings[MarkerSeverity.Error] = (0, nls_js_1.localize)('sev.error', "Error");
    _displayStrings[MarkerSeverity.Warning] = (0, nls_js_1.localize)('sev.warning', "Warning");
    _displayStrings[MarkerSeverity.Info] = (0, nls_js_1.localize)('sev.info', "Info");
    function toString(a) {
    ...
    function toSeverity(severity) {
        switch (severity) {
            case MarkerSeverity.Error: return severity_js_1.default.Error;
            case MarkerSeverity.Warning: return severity_js_1.default.Warning;
            case MarkerSeverity.Info: return severity_js_1.default.Info;
            case MarkerSeverity.Hint: return severity_js_1.default.Ignore;
        }
    }
...
exports.IMarkerService = (0, instantiation_js_1.createDecorator)('markerService');
