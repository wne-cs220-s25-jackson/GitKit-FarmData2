...
exports.hotClassGetOriginalInstance = hotClassGetOriginalInstance;
exports.wrapInHotClass0 = wrapInHotClass0;
exports.wrapInHotClass1 = wrapInHotClass1;
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
const hotReload_js_1 = require("../../../base/common/hotReload.js");
...
function wrapInHotClass0(clazz) {
    return !(0, hotReload_js_1.isHotReloadEnabled)() ? clazz.get() : createWrapper(clazz, BaseClass0);
}
class BaseClass {
...
function createWrapper(clazz, B) {
    return (class ReloadableWrapper extends B {
        ...
        init(...params) {
            this._autorun = (0, observable_js_1.autorunWithStore)((reader, store) => {
...
function wrapInHotClass1(clazz) {
    return !(0, hotReload_js_1.isHotReloadEnabled)() ? clazz.get() : createWrapper(clazz, BaseClass1);
}
