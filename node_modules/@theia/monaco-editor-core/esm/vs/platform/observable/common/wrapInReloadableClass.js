...
exports.wrapInReloadableClass0 = wrapInReloadableClass0;
...
function wrapInReloadableClass0(getClass) {
    return !(0, hotReload_js_1.isHotReloadEnabled)() ? getClass() : createWrapper(getClass, BaseClass0);
}
class BaseClass {
    ...
    return (class ReloadableWrapper extends B {
        ...
        init(...params) {
            this._autorun = (0, observable_js_1.autorunWithStore)((reader, store) => {
                const clazz = (0, hotReloadHelpers_js_1.readHotReloadableExport)(getClass(), reader);
...
function wrapInReloadableClass1(getClass) {
    return !(0, hotReload_js_1.isHotReloadEnabled)() ? getClass() : createWrapper(getClass, BaseClass1);
}
