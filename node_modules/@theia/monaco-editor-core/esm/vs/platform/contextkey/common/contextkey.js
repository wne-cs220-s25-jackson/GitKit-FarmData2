...
CONSTANT_VALUES.set('isMac', platform_js_1.isMacintosh);
CONSTANT_VALUES.set('isLinux', platform_js_1.isLinux);
CONSTANT_VALUES.set('isWindows', platform_js_1.isWindows);
CONSTANT_VALUES.set('isWeb', platform_js_1.isWeb);
CONSTANT_VALUES.set('isMacNative', platform_js_1.isMacintosh && !platform_js_1.isWeb);
CONSTANT_VALUES.set('isEdge', platform_js_1.isEdge);
CONSTANT_VALUES.set('isFirefox', platform_js_1.isFirefox);
CONSTANT_VALUES.set('isChrome', platform_js_1.isChrome);
CONSTANT_VALUES.set('isSafari', platform_js_1.isSafari);
/** allow register constant context keys that are known only after startup; requires running `substituteConstants` on the context key - https://github.com/microsoft/vscode/issues/174218#issuecomment-1437972127 */
function setConstant(key, value) {
    if (CONSTANT_VALUES.get(key) !== undefined) {
        throw (0, errors_js_1.illegalArgument)('contextkey.setConstant(k, v) invoked with already set constant `k`');
    }
...
const errorEmptyString = (0, nls_js_1.localize)('contextkey.parser.error.emptyString', "Empty context key expression");
const hintEmptyString = (0, nls_js_1.localize)('contextkey.parser.error.emptyString.hint', "Did you forget to write an expression? You can also put 'false' or 'true' to always evaluate to false or true, respectively.");
const errorNoInAfterNot = (0, nls_js_1.localize)('contextkey.parser.error.noInAfterNot', "'in' after 'not'.");
const errorClosingParenthesis = (0, nls_js_1.localize)('contextkey.parser.error.closingParenthesis', "closing parenthesis ')'");
const errorUnexpectedToken = (0, nls_js_1.localize)('contextkey.parser.error.unexpectedToken', "Unexpected token");
const hintUnexpectedToken = (0, nls_js_1.localize)('contextkey.parser.error.unexpectedToken.hint', "Did you forget to put && or || before the token?");
const errorUnexpectedEOF = (0, nls_js_1.localize)('contextkey.parser.error.unexpectedEOF', "Unexpected end of expression");
const hintUnexpectedEOF = (0, nls_js_1.localize)('contextkey.parser.error.unexpectedEOF.hint', "Did you forget to put a context key?");
/**
...
class Parser {
    ...
    constructor(_config = defaultConfig) {
        ...
        this._scanner = new scanner_js_1.Scanner();
    ...
    parse(input) {
        ...
        try {
            ...
            if (!this._isAtEnd()) {
                ...
                this._parsingErrors.push({ message: errorUnexpectedToken, offset: peek.offset, lexeme: scanner_js_1.Scanner.getLexeme(peek), additionalInfo });
                    ...
                    switch (expr.type) {
                        ...
                        case 19 /* TokenType.Error */: { // also handle an ErrorToken in case of smth such as /(/file)/
                            ...
                            while (!this._isAtEnd() && followingToken.type !== 15 /* TokenType.And */ && followingToken.type !== 16 /* TokenType.Or */) {
                                ...
                                lexemeReconstruction.push(scanner_js_1.Scanner.getLexeme(followingToken));
                                this._advance();
                        ...
                        case 18 /* TokenType.QuotedStr */: {
                            ...
                            let regex = null;
                            if (!(0, strings_js_1.isFalsyOrWhitespace)(serializedValue)) {
    ...
    _errExpectedButGot(expected, got, additionalInfo) {
        const message = (0, nls_js_1.localize)('contextkey.parser.error.expectedButGot', "Expected: {0}\nReceived: '{1}'.", expected, scanner_js_1.Scanner.getLexeme(got));
        const offset = got.offset;
        const lexeme = scanner_js_1.Scanner.getLexeme(got);
        ...
        if (parser.lexingErrors.length > 0) {
            return parser.lexingErrors.map((se) => ({
                errorMessage: se.additionalInfo ?
                    (0, nls_js_1.localize)('contextkey.scanner.errorForLinterWithHint', "Unexpected token. Hint: {0}", se.additionalInfo) :
                    (0, nls_js_1.localize)('contextkey.scanner.errorForLinter', "Unexpected token."),
                offset: se.offset,
...
exports.IContextKeyService = (0, instantiation_js_1.createDecorator)('contextKeyService');
