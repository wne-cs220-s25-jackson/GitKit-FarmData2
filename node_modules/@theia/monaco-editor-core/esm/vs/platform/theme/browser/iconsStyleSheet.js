...
const css = require("../../../base/browser/cssValue.js");
const event_js_1 = require("../../../base/common/event.js");
const lifecycle_js_1 = require("../../../base/common/lifecycle.js");
const themables_js_1 = require("../../../base/common/themables.js");
const iconRegistry_js_1 = require("../common/iconRegistry.js");
function getIconsStyleSheet(themeService) {
    const disposable = new lifecycle_js_1.DisposableStore();
    const onDidChangeEmmiter = disposable.add(new event_js_1.Emitter());
    const iconRegistry = (0, iconRegistry_js_1.getIconRegistry)();
