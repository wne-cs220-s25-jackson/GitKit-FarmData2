...
const extensions_js_1 = require("../../instantiation/common/extensions.js");
const notification_js_1 = require("../../notification/common/notification.js");
const undoRedo_js_1 = require("./undoRedo.js");
const DEBUG = false;
function getResourceLabel(resource) {
    return resource.scheme === network_js_1.Schemas.file ? resource.fsPath : resource.path;
}
...
class ResourceEditStack {
    ...
    createSnapshot(resource) {
        ...
        return new undoRedo_js_1.ResourceEditStackSnapshot(resource, elements);
    }
...
let UndoRedoService = class UndoRedoService {
    ...
    pushElement(element, group = undoRedo_js_1.UndoRedoGroup.None, source = undoRedo_js_1.UndoRedoSource.None) {
    ...
    createSnapshot(resource) {
        ...
        return new undoRedo_js_1.ResourceEditStackSnapshot(resource, []);
    }
    restoreSnapshot(snapshot) {
    ...
    canUndo(resourceOrSource) {
        if (resourceOrSource instanceof undoRedo_js_1.UndoRedoSource) {
    ...
    _invokeResourcePrepare(element, callback) {
        if (element.actual.type !== 1 /* UndoRedoElementType.Workspace */ || typeof element.actual.prepareUndoRedo === 'undefined') {
            ...
            return callback(lifecycle_js_1.Disposable.None);
        }
        ...
        if ((0, lifecycle_js_1.isDisposable)(r)) {
            return callback(r);
        }
    ...
    async _confirmAndExecuteWorkspaceUndo(strResource, element, editStackSnapshot, undoConfirmed) {
        if (element.canSplit() && !this._isPartOfUndoGroup(element)) {
            ...
            const { result } = await this._dialogService.prompt({
                type: severity_js_1.default.Info,
...
exports.UndoRedoService = UndoRedoService = __decorate([
    __param(0, dialogs_js_1.IDialogService),
...
(0, extensions_js_1.registerSingleton)(undoRedo_js_1.IUndoRedoService, UndoRedoService, 1 /* InstantiationType.Delayed */);
