...
const listService_js_1 = require("../../list/browser/listService.js");
const themeService_js_1 = require("../../theme/common/themeService.js");
const lifecycle_js_1 = require("../../../base/common/lifecycle.js");
const quickInput_js_1 = require("../common/quickInput.js");
const keyboardEvent_js_1 = require("../../../base/browser/keyboardEvent.js");
const platform_js_1 = require("../../../base/common/platform.js");
const decorators_js_1 = require("../../../base/common/decorators.js");
...
const theme_js_1 = require("../../theme/common/theme.js");
const uri_js_1 = require("../../../base/common/uri.js");
const quickInputUtils_js_1 = require("./quickInputUtils.js");
const lazy_js_1 = require("../../../base/common/lazy.js");
const iconLabels_js_1 = require("../../../base/common/iconLabels.js");
const comparers_js_1 = require("../../../base/common/comparers.js");
...
const accessibility_js_1 = require("../../accessibility/common/accessibility.js");
...
class BaseQuickPickItemElement {
    constructor(index, hasCheckbox, mainItem) {
        ...
        this._hidden = false;
        this._init = new lazy_js_1.Lazy(() => {
            const saneLabel = mainItem.label ?? '';
            const saneSortLabel = (0, iconLabels_js_1.parseLabelWithIcons)(saneLabel).text.trim();
            const saneAriaLabel = mainItem.ariaLabel || [saneLabel, this.saneDescription, this.saneDetail]
                .map(s => (0, iconLabels_js_1.getCodiconAriaLabel)(s))
                .filter(s => !!s)
                .join(', ');
            return {
                saneLabel,
...
class QuickPickItemElement extends BaseQuickPickItemElement {
    constructor(index, hasCheckbox, fireButtonTriggered, _onChecked, item, _separator) {
        ...
        this.onChecked = hasCheckbox
            ? event_js_1.Event.map(event_js_1.Event.filter(this._onChecked.event, e => e.element === this), e => e.checked)
            : event_js_1.Event.None;
...
class QuickInputAccessibilityProvider {
    getWidgetAriaLabel() {
        return (0, nls_js_1.localize)('quickInput', "Quick Input");
    }
...
class BaseQuickInputListRenderer {
    ...
    renderTemplate(container) {
        ...
        data.toDisposeElement = new lifecycle_js_1.DisposableStore();
        data.toDisposeTemplate = new lifecycle_js_1.DisposableStore();
        ...
        // Label
        data.label = new iconLabel_js_1.IconLabel(row1, { supportHighlights: true, supportDescriptionHighlights: true, supportIcons: true, hoverDelegate: this.hoverDelegate });
        data.toDisposeTemplate.add(data.label);
        data.icon = dom.prepend(data.label.element, $('.quick-input-list-icon'));
        // Keybinding
        const keybindingContainer = dom.append(row1, $('.quick-input-list-entry-keybinding'));
        data.keybinding = new keybindingLabel_js_1.KeybindingLabel(keybindingContainer, platform_js_1.OS);
        data.toDisposeTemplate.add(data.keybinding);
        // Detail
        const detailContainer = dom.append(row2, $('.quick-input-list-label-meta'));
        data.detail = new iconLabel_js_1.IconLabel(detailContainer, { supportHighlights: true, supportIcons: true, hoverDelegate: this.hoverDelegate });
        data.toDisposeTemplate.add(data.detail);
        // Separator
        data.separator = dom.append(data.entry, $('.quick-input-list-separator'));
        // Actions
        data.actionBar = new actionbar_js_1.ActionBar(data.entry, this.hoverDelegate ? { hoverDelegate: this.hoverDelegate } : undefined);
...
let QuickPickItemElementRenderer = class QuickPickItemElementRenderer extends BaseQuickInputListRenderer {
    ...
    renderElement(node, index, data) {
        ...
        if (mainItem.iconPath) {
            const icon = (0, theme_js_1.isDark)(this.themeService.getColorTheme().type) ? mainItem.iconPath.dark : (mainItem.iconPath.light ?? mainItem.iconPath.dark);
            const iconUrl = uri_js_1.URI.revive(icon);
        ...
        if (!element.saneTooltip && element.saneDescription) {
            descriptionTitle = {
                markdown: {
                    value: (0, strings_js_1.escape)(element.saneDescription),
        ...
        if (element.saneDetail) {
            ...
            if (!element.saneTooltip) {
                title = {
                    markdown: {
                        value: (0, strings_js_1.escape)(element.saneDetail),
                        supportThemeIcons: true
                    },
        ...
        if (buttons && buttons.length) {
            data.actionBar.push(buttons.map((button, index) => (0, quickInputUtils_js_1.quickInputButtonToAction)(button, `id-${index}`, () => element.fireButtonTriggered({ button, item: element.item }))), { icon: true, label: false });
...
class QuickPickSeparatorElementRenderer extends BaseQuickInputListRenderer {
    ...
    renderElement(node, index, data) {
        ...
        const buttons = mainItem.buttons;
        if (buttons && buttons.length) {
            data.actionBar.push(buttons.map((button, index) => (0, quickInputUtils_js_1.quickInputButtonToAction)(button, `id-${index}`, () => element.fireSeparatorButtonTriggered({ button, separator: element.separator }))), { icon: true, label: false });
            data.entry.classList.add('has-actions');
        }
        else {
            data.entry.classList.remove('has-actions');
...
let QuickInputTree = class QuickInputTree extends lifecycle_js_1.Disposable {
    constructor(parent, hoverDelegate, linkOpenerDelegate, id, instantiationService, accessibilityService) {
        ...
        this._onKeyDown = new event_js_1.Emitter();
        /**
         * Event that is fired when the tree receives a keydown.
        */
        this.onKeyDown = this._onKeyDown.event;
        this._onLeave = new event_js_1.Emitter();
        /**
         * Event that is fired when the tree would no longer have focus.
        */
        this.onLeave = this._onLeave.event;
        this._visibleCountObservable = (0, observable_js_1.observableValue)('VisibleCount', 0);
        this.onChangedVisibleCount = event_js_1.Event.fromObservable(this._visibleCountObservable, this._store);
        this._allVisibleCheckedObservable = (0, observable_js_1.observableValue)('AllVisibleChecked', false);
        this.onChangedAllVisibleChecked = event_js_1.Event.fromObservable(this._allVisibleCheckedObservable, this._store);
        this._checkedCountObservable = (0, observable_js_1.observableValue)('CheckedCount', 0);
        this.onChangedCheckedCount = event_js_1.Event.fromObservable(this._checkedCountObservable, this._store);
        this._checkedElementsObservable = (0, observable_js_1.observableValueOpts)({ equalsFn: arrays_js_1.equals }, new Array());
        this.onChangedCheckedElements = event_js_1.Event.fromObservable(this._checkedElementsObservable, this._store);
        this._onButtonTriggered = new event_js_1.Emitter();
        this.onButtonTriggered = this._onButtonTriggered.event;
        this._onSeparatorButtonTriggered = new event_js_1.Emitter();
        this.onSeparatorButtonTriggered = this._onSeparatorButtonTriggered.event;
        this._elementChecked = new event_js_1.Emitter();
        this._elementCheckedEventBufferer = new event_js_1.EventBufferer();
        //#endregion
        ...
        this._elementDisposable = this._register(new lifecycle_js_1.DisposableStore());
        ...
        this._tree = this._register(instantiationService.createInstance((listService_js_1.WorkbenchObjectTree), 'QuickInput', this._container, new QuickInputItemDelegate(), [this._itemRenderer, this._separatorRenderer], {
            filter: {
                filter(element) {
            ...
            renderIndentGuides: abstractTree_js_1.RenderIndentGuides.None,
    ...
    get onDidChangeFocus() {
        return event_js_1.Event.map(this._tree.onDidChangeFocus, e => e.elements.filter((e) => e instanceof QuickPickItemElement).map(e => e.item), this._store);
    }
    get onDidChangeSelection() {
        return event_js_1.Event.map(this._tree.onDidChangeSelection, e => ({
    ...
    _registerHoverListeners() {
        const delayer = this._register(new async_js_1.ThrottledDelayer(this.hoverDelegate.delay));
        this._register(this._tree.onMouseOver(async (e) => {
            ...
            try {
                ...
                if (!(0, errors_js_1.isCancellationError)(e)) {
                    throw e;
                }
            }
        }));
    ...
    focus(what) {
        ...
        if (what === quickInput_js_1.QuickPickFocus.Second && this._itemElements.length < 2) {
            what = quickInput_js_1.QuickPickFocus.First;
        }
        switch (what) {
            case quickInput_js_1.QuickPickFocus.First:
                this._tree.scrollTop = 0;
                this._tree.focusFirst(undefined, (e) => e.element instanceof QuickPickItemElement);
                break;
            case quickInput_js_1.QuickPickFocus.Second: {
                this._tree.scrollTop = 0;
            ...
            case quickInput_js_1.QuickPickFocus.Previous: {
                const prevFocus = this._tree.getFocus();
            ...
            case quickInput_js_1.QuickPickFocus.NextPage:
                ...
                break;
            case quickInput_js_1.QuickPickFocus.PreviousPage:
                ...
                break;
            case quickInput_js_1.QuickPickFocus.NextSeparator: {
            ...
            case quickInput_js_1.QuickPickFocus.PreviousSeparator: {
                let focusElement;
        ...
        // Filter by value (since we support icons in labels, use $(..) aware fuzzy matching)
            ...
            this._itemElements.forEach(element => {
                ...
                if (this.matchOnLabelMode === 'fuzzy') {
                    labelHighlights = this.matchOnLabel ? (0, iconLabels_js_1.matchesFuzzyIconAware)(query, (0, iconLabels_js_1.parseLabelWithIcons)(element.saneLabel)) ?? undefined : undefined;
                }
                else {
                    labelHighlights = this.matchOnLabel ? matchesContiguousIconAware(queryWithWhitespace, (0, iconLabels_js_1.parseLabelWithIcons)(element.saneLabel)) ?? undefined : undefined;
                }
                const descriptionHighlights = this.matchOnDescription ? (0, iconLabels_js_1.matchesFuzzyIconAware)(query, (0, iconLabels_js_1.parseLabelWithIcons)(element.saneDescription || '')) ?? undefined : undefined;
                const detailHighlights = this.matchOnDetail ? (0, iconLabels_js_1.matchesFuzzyIconAware)(query, (0, iconLabels_js_1.parseLabelWithIcons)(element.saneDetail || '')) ?? undefined : undefined;
...
function compareEntries(elementA, elementB, lookFor) {
    ...
    return (0, comparers_js_1.compareAnything)(elementA.saneSortLabel, elementB.saneSortLabel, lookFor);
}
