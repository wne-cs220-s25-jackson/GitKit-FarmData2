...
class PickerQuickAccessProvider extends lifecycle_js_1.Disposable {
    ...
    provide(picker, token, runOptions) {
        ...
        const picksDisposable = disposables.add(new lifecycle_js_1.MutableDisposable());
        const updatePickerItems = async () => {
            const picksDisposables = picksDisposable.value = new lifecycle_js_1.DisposableStore();
            // Cancel any previous ask for picks and busy
            picksCts?.dispose(true);
            picker.busy = false;
            // Create new cancellation source for this run
            picksCts = new cancellation_js_1.CancellationTokenSource(token);
            ...
            const applyPicks = (picks, skipEmpty) => {
                ...
                if (items.length === 0) {
                    ...
                    if ((picksFilter.length > 0 || picker.hideInput) && this.options?.noResultsPick) {
                        if ((0, types_js_1.isFunction)(this.options.noResultsPick)) {
                ...
                await Promise.all([
                    ...
                    (async () => {
                        if (typeof fastAndSlowPicks.mergeDelay === 'number') {
                            await (0, async_js_1.timeout)(fastAndSlowPicks.mergeDelay);
