...
const tfIdf_js_1 = require("../../../base/common/tfIdf.js");
...
const dialogs_js_1 = require("../../dialogs/common/dialogs.js");
...
const pickerQuickAccess_js_1 = require("./pickerQuickAccess.js");
const storage_js_1 = require("../../storage/common/storage.js");
const telemetry_js_1 = require("../../telemetry/common/telemetry.js");
let AbstractCommandsQuickAccessProvider = class AbstractCommandsQuickAccessProvider extends pickerQuickAccess_js_1.PickerQuickAccessProvider {
    static { AbstractCommandsQuickAccessProvider_1 = this; }
    static { this.PREFIX = '>'; }
    static { this.TFIDF_THRESHOLD = 0.5; }
    static { this.TFIDF_MAX_RESULTS = 5; }
    static { this.WORD_FILTER = (0, filters_js_1.or)(filters_js_1.matchesPrefix, filters_js_1.matchesWords, filters_js_1.matchesContiguousSubString); }
    ...
    async _getPicks(filter, _disposables, token, runOptions) {
        ...
        const runTfidf = (0, functional_js_1.createSingleCallFunction)(() => {
            const tfidf = new tfIdf_js_1.TfIdfCalculator();
            tfidf.updateDocuments(allCommandPicks.map(commandPick => ({
                key: commandPick.commandId,
                textChunks: [this.getTfIdfChunk(commandPick)]
            })));
            const result = tfidf.calculateScores(filter, token);
            return (0, tfIdf_js_1.normalizeTfIdfScores)(result)
        ...
        for (let i = 0; i < filteredCommandPicks.length; i++) {
            ...
            if (i === 0 && this.commandsHistory.peek(commandPick.commandId)) {
                commandPicks.push({ type: 'separator', label: (0, nls_js_1.localize)('recentlyUsed', "recently used") });
                addOtherSeparator = true;
            }
            if (addSuggestedSeparator && commandPick.tfIdfScore !== undefined) {
                commandPicks.push({ type: 'separator', label: (0, nls_js_1.localize)('suggested', "similar commands") });
            ...
            if (addCommonlyUsedSeparator && commandPick.tfIdfScore === undefined && !this.commandsHistory.peek(commandPick.commandId) && this.options.suggestedCommandIds?.has(commandPick.commandId)) {
                commandPicks.push({ type: 'separator', label: (0, nls_js_1.localize)('commonlyUsed', "commonly used") });
                addOtherSeparator = true;
            ...
            if (addOtherSeparator && commandPick.tfIdfScore === undefined && !this.commandsHistory.peek(commandPick.commandId) && !this.options.suggestedCommandIds?.has(commandPick.commandId)) {
                commandPicks.push({ type: 'separator', label: (0, nls_js_1.localize)('morecCommands', "other commands") });
        ...
        return {
            ...
            additionalPicks: (async () => {
                ...
                if (addSuggestedSeparator && commandPicks[0]?.type !== 'separator') {
                    commandPicks.unshift({ type: 'separator', label: (0, nls_js_1.localize)('suggested', "similar commands") });
                }
                return commandPicks;
            })()
        };
    ...
    toCommandPick(commandPick, runOptions) {
        ...
        const ariaLabel = keybinding ?
            (0, nls_js_1.localize)('commandPickAriaLabelWithKeybinding', "{0}, {1}", commandPick.label, keybinding.getAriaLabel()) :
            commandPick.label;
        return {
            ...commandPick,
            ariaLabel,
            ...
            accept: async () => {
                ...
                try {
                    ...
                    if (!(0, errors_js_1.isCancellationError)(error)) {
                        this.dialogService.error((0, nls_js_1.localize)('canNotRun', "Command '{0}' resulted in an error", commandPick.label), (0, errorMessage_js_1.toErrorMessage)(error));
                    }
                }
            }
        };
...
let CommandsHistory = class CommandsHistory extends lifecycle_js_1.Disposable {
    ...
    registerListeners() {
        ...
        this._register(this.storageService.onWillSaveState(e => {
            if (e.reason === storage_js_1.WillSaveStateReason.SHUTDOWN) {
    ...
    load() {
        ...
        const cache = CommandsHistory_1.cache = new map_js_1.LRUCache(this.configuredCommandsHistoryLength, 1);
        if (serializedCache) {
            let entries;
    ...
    static clearHistory(configurationService, storageService) {
        ...
        CommandsHistory_1.cache = new map_js_1.LRUCache(commandHistoryLength);
